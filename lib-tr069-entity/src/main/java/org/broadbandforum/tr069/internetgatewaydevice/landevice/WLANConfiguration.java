...
import org.broadbandforum.tr069.internetgatewaydevice.landevice.wlanconfiguration.AssociatedDevice;
import org.broadbandforum.tr069.internetgatewaydevice.landevice.wlanconfiguration.PreSharedKey;
import org.broadbandforum.tr069.internetgatewaydevice.landevice.wlanconfiguration.WEPKey;
...
public class WLANConfiguration {
	...
	/**
	 * Indicates which IEEE 802.11 mode the device is currently operating in.
	 *
	 * @since 1.0
	 */
...
This parameter is the same as the parameter {{param|InternetGatewayDevice.LANDevice.{i}.WLANConfiguration.{i}.PreSharedKey.1.KeyPassprhase}} for the same instance of ''WLANConfiguration''.  When either parameter is changed, the value of the other is changed as well.
...
Ranges in the form "n-m" are permitted.
	...
	/**
	 * Get the breacon types to be use with this connection.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the breacon types to be use with this connection.
	 *
	 * @since 1.0
	...
	/**
	 * Get the indicates which IEEE 802.11 mode the device is currently operating in.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the indicates which IEEE 802.11 mode the device is currently operating in.
	 *
	 * @since 1.0
	...
	/**
	 * Get a passphrase from which the WEP keys were generated.  This parameter for information only-the CPE is not responsible for generating the key based on the passphrase.
...
Note: If a passphrase is used, all four WEP keys will be the same.
	...
	/**
	 * Set a passphrase from which the WEP keys were generated.  This parameter for information only-the CPE is not responsible for generating the key based on the passphrase.
...
Any additional vendor-specific values must start with the key length in bits.
	...
	/**
	 * Get the encryption modes that are available when basic 802.11 is enabled. {{enum|WEPEncryption}} implies that all wireless clients can use WEP for data encryption.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the encryption modes that are available when basic 802.11 is enabled. {{enum|WEPEncryption}} implies that all wireless clients can use WEP for data encryption.
	 *
	 * @since 1.0
	...
	/**
	 * Get authentication modes that are available when basic 802.11 is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set authentication modes that are available when basic 802.11 is enabled.
	 *
	 * @since 1.0
	...
	/**
	 * Get the encryption modes that are available when WPA is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the encryption modes that are available when WPA is enabled.
	 *
	 * @since 1.0
	...
	/**
	 * Get authentication modes that are available when WPA is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set authentication modes that are available when WPA is enabled.
	 *
	 * @since 1.0
	...
	/**
	 * Get the encryption modes that are available when 802.11i is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the encryption modes that are available when 802.11i is enabled.
	 *
	 * @since 1.0
	...
	/**
	 * Get authentication modes that are available when 802.11i is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set authentication modes that are available when 802.11i is enabled.
	 *
	 * @since 1.0
