...
@XmlRootElement(name = "InternetGatewayDevice.WANDevice.WANDSLInterfaceConfig.Stats.Total")
...
public class Total {
	...
	/**
	 * Get the total number of successfully received blocks.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the total number of successfully received blocks.
	 *
	 * @since 1.0
	...
	/**
	 * Get the total number of successfully transmitted blocks.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the total number of successfully transmitted blocks.
	 *
	 * @since 1.0
