...
import org.broadbandforum.tr069.internetgatewaydevice.wandevice.wancommoninterfaceconfig.Connection;
...
public class WANCommonInterfaceConfig {
	...
	/**
	 * Specifies the maximum upstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Specifies the maximum downstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Get the specifies the maximum upstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the specifies the maximum upstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
	...
	/**
	 * Get the specifies the maximum downstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the specifies the maximum downstream theoretical bit rate for the WAN device in bits per second.
	 *
	 * @since 1.0
