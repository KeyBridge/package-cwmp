...
public class CurrentDay {
	...
	/**
	 * Get the number of successfully received blocks during the current day.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully received blocks during the current day.
	 *
	 * @since 1.0
	...
	/**
	 * Get the number of successfully transmitted blocks during the current day.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully transmitted blocks during the current day.
	 *
	 * @since 1.0
