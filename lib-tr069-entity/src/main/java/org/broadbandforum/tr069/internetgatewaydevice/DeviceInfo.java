...
import org.broadbandforum.tr069.internetgatewaydevice.deviceinfo.VendorConfigFile;
...
To allow version comparisons, this element SHOULD be in the form of dot-delimited integers, where each successive integer represents a more minor category of variation.  For example, ''3.0.21''where the components mean: ''Major.Minor.Build''.
	...
	/**
	 * The OptionName of each Option that is currently enabled in the CPE.  The OptionName of each is identical to the OptionName element of the OptionStruct described in {{bibref|TR-069|Table 48}}.  Only those options are listed whose State indicates the option is enabled.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Represents any additional hardware version information the vendor may wish to supply.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Represents any additional software version information the vendor may wish to supply.
	 *
	 * @since 1.0
	 */
...
If not {{empty}}, this argument SHOULD be in the form of a hierarchical descriptor with one or more nodes specified.  Each node in the hierarchy is represented as a 4-character sub-string, containing only numerals or upper-case letters.  If there is more than one node indicated, each node is separated by a "." (dot).  Examples: "TLCO" or "TLCO.GRP2".
	...
	public Long uptime;
	/**
	 * Date and time in UTC that the CPE first successfully established a network connection.
	 *
	 * @since 1.0
	 */
...
To allow version comparisons, this element SHOULD be in the form of dot-delimited integers, where each successive integer represents a more minor category of variation.  For example, ''3.0.21''where the components mean: ''Major.Minor.Build''.
	...
	/**
	 * Get the OptionName of each Option that is currently enabled in the CPE.  The OptionName of each is identical to the OptionName element of the OptionStruct described in {{bibref|TR-069|Table 48}}.  Only those options are listed whose State indicates the option is enabled.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the OptionName of each Option that is currently enabled in the CPE.  The OptionName of each is identical to the OptionName element of the OptionStruct described in {{bibref|TR-069|Table 48}}.  Only those options are listed whose State indicates the option is enabled.
	 *
	 * @since 1.0
	...
	/**
	 * Get the represents any additional hardware version information the vendor may wish to supply.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the represents any additional hardware version information the vendor may wish to supply.
	 *
	 * @since 1.0
	...
	/**
	 * Get the represents any additional software version information the vendor may wish to supply.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the represents any additional software version information the vendor may wish to supply.
	 *
	 * @since 1.0
	...
	/**
	 * Get the represents the version of the specification implemented by the device.  Currently 1.0 is the only available version.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the represents the version of the specification implemented by the device.  Currently 1.0 is the only available version.
	 *
	 * @since 1.0
	...
	/**
	 * Get the identifier of the primary service provider and other provisioning information, which MAY be used by the Server to determine service provider-specific customization and provisioning parameters.
...
If not {{empty}}, this argument SHOULD be in the form of a hierarchical descriptor with one or more nodes specified.  Each node in the hierarchy is represented as a 4-character sub-string, containing only numerals or upper-case letters.  If there is more than one node indicated, each node is separated by a "." (dot).  Examples: "TLCO" or "TLCO.GRP2".
	...
	/**
	 * Set the identifier of the primary service provider and other provisioning information, which MAY be used by the Server to determine service provider-specific customization and provisioning parameters.
...
If not {{empty}}, this argument SHOULD be in the form of a hierarchical descriptor with one or more nodes specified.  Each node in the hierarchy is represented as a 4-character sub-string, containing only numerals or upper-case letters.  If there is more than one node indicated, each node is separated by a "." (dot).  Examples: "TLCO" or "TLCO.GRP2".
	...
	/**
	 * Get the date and time in UTC that the CPE first successfully established a network connection.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the date and time in UTC that the CPE first successfully established a network connection.
	 *
	 * @since 1.0
