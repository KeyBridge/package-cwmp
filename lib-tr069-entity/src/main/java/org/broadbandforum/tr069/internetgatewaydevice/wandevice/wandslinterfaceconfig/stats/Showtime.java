...
public class Showtime {
	...
	/**
	 * Number of successfully received blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Number of successfully transmitted blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * Get the number of successfully received blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully received blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
	...
	/**
	 * Get the number of successfully transmitted blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully transmitted blocks since the most recent DSL Showtime.
	 *
	 * @since 1.0
