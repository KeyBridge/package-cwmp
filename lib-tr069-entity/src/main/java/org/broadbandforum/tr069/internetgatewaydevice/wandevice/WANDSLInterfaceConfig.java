...
import org.broadbandforum.tr069.internetgatewaydevice.wandevice.wandslinterfaceconfig.Stats;
...
public class WANDSLInterfaceConfig {
	...
	/**
	 * ADSL Interleaved depth.  This variable is only applicable if {{param|DataPath}} = {{enum|Interleaved|DataPath}}.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * The current payload bandwidth (expressed in Kbps) of the upstream DSL channel.
	 *
	 * @since 1.0
	 */
	...
	/**
	 * The current payload bandwidth (expressed in Kbps) of the downstream DSL channel.
	 *
	 * @since 1.0
	 */
...
Statistics SHOULD continue to be accumulated across CPE reboots, though this may not always be possible.
	...
	/**
	 * Get the status of the DSL physical link.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the status of the DSL physical link.
	 *
	 * @since 1.0
	...
	/**
	 * Get adsL Interleaved depth.  This variable is only applicable if {{param|DataPath}} = {{enum|Interleaved|DataPath}}.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set adsL Interleaved depth.  This variable is only applicable if {{param|DataPath}} = {{enum|Interleaved|DataPath}}.
	 *
	 * @since 1.0
	...
	/**
	 * Get the current payload bandwidth (expressed in Kbps) of the upstream DSL channel.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the current payload bandwidth (expressed in Kbps) of the upstream DSL channel.
	 *
	 * @since 1.0
	...
	/**
	 * Get the current payload bandwidth (expressed in Kbps) of the downstream DSL channel.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the current payload bandwidth (expressed in Kbps) of the downstream DSL channel.
	 *
	 * @since 1.0
	...
	/**
	 * Get atu-R vendor identifier as defined in G.994.1 and T1.413.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set atu-R vendor identifier as defined in G.994.1 and T1.413.
	 *
	 * @since 1.0
	...
	/**
	 * Get the t.35 country code of the ATU-R vendor as defined in G.994.1.
	 *
	 * @since 1.0
	 * @return the value
	 */
	public Long getAtuRCountry() {
		return atuRCountry;
	}

	/**
	 * Set the t.35 country code of the ATU-R vendor as defined in G.994.1.
	 *
	 * @since 1.0
	 * @param atuRCountry the input value
	 */
	public void  setAtuRCountry(Long atuRCountry) {
	 ...
	 * @return this instance
	 */
	public WANDSLInterfaceConfig withAtuRCountry(Long atuRCountry) {
		this.atuRCountry = atuRCountry;
		return this;
	}
	...
	/**
	 * Get atu-C vendor identifier as defined in G.994.1 and T1.413.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set atu-C vendor identifier as defined in G.994.1 and T1.413.
	 *
	 * @since 1.0
	...
	/**
	 * Get the t.35 country code of the ATU-C vendor as defined in G.994.1.
	 *
	 * @since 1.0
	 * @return the value
	 */
	public Long getAtuCCountry() {
		return atuCCountry;
	}

	/**
	 * Set the t.35 country code of the ATU-C vendor as defined in G.994.1.
	 *
	 * @since 1.0
	 * @param atuCCountry the input value
	 */
	public void  setAtuCCountry(Long atuCCountry) {
	 ...
	 * @return this instance
	 */
	public WANDSLInterfaceConfig withAtuCCountry(Long atuCCountry) {
		this.atuCCountry = atuCCountry;
		return this;
	}
