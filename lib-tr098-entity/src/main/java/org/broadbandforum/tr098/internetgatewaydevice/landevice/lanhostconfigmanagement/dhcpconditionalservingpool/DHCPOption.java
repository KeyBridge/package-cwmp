...
import org.broadbandforum.tr098.datatypes.Alias;
	 ...
	 * @since 1.4
	 */
@CWMPObject(name = "InternetGatewayDevice.LANDevice.{i}.LANHostConfigManagement.DHCPConditionalServingPool.{i}.DHCPOption.{i}.")
@XmlRootElement(name = "DHCPOption")
@XmlType(name = "InternetGatewayDevice.LANDevice.LANHostConfigManagement.DHCPConditionalServingPool.DHCPOption")
