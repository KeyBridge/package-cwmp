...
import org.broadbandforum.tr098.internetgatewaydevice.fap.perfmgmt.Config;
	 ...
	 * @since 1.10
	 */
@CWMPObject(name = "InternetGatewayDevice.FAP.PerfMgmt.")
@XmlRootElement(name = "PerfMgmt")
@XmlType(name = "InternetGatewayDevice.FAP.PerfMgmt")
