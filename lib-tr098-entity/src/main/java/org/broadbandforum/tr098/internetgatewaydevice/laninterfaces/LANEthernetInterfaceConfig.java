...
The object definition is identical to that for {{object|InternetGatewayDevice.LANDevice.{i}.LANEthernetInterfaceConfig.{i}}}.
	 ...
	 * @since 1.4
	 */
@CWMPObject(name = "InternetGatewayDevice.LANInterfaces.LANEthernetInterfaceConfig.{i}.")
@XmlRootElement(name = "LANEthernetInterfaceConfig")
@XmlType(name = "InternetGatewayDevice.LANInterfaces.LANEthernetInterfaceConfig")
