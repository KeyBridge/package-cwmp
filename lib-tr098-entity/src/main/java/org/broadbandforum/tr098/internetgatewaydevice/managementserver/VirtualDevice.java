...
import org.broadbandforum.annotation.CWMPObject;
	 ...
	 * @since 1.9
	 */
@CWMPObject(name = "InternetGatewayDevice.ManagementServer.VirtualDevice.{i}.")
@XmlRootElement(name = "VirtualDevice")
@XmlType(name = "InternetGatewayDevice.ManagementServer.VirtualDevice")
...
The value MUST be a valid OUI as defined in {{bibref|OUI}}.
	...
	/**
	 * Get the {{list}} {{reference}}  References all the {{object|.LANDevice.{i}.Hosts.Host}} table entries, whether active or inactive, that correspond to this proxied LAN device.  There can be multiple such entries if the Proxied Device has more than one network interface.
	 *
	 * @since 1.9
	 * @return the value
	 */
	...
	/**
	 * Set the {{list}} {{reference}}  References all the {{object|.LANDevice.{i}.Hosts.Host}} table entries, whether active or inactive, that correspond to this proxied LAN device.  There can be multiple such entries if the Proxied Device has more than one network interface.
	 *
	 * @since 1.9
