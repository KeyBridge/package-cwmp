...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of successfully received blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662 {{bibref|RFC2662}}.
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of successfully received blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662 {{bibref|RFC2662}}.
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	 ...
	 */
	public LastShowtime withReceiveBlocks(Long receiveBlocks) {
		this.receiveBlocks = receiveBlocks;
		return this;
	}

	/**
	 * Get the number of successfully transmitted blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662 {{bibref|RFC2662}}.
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of successfully transmitted blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662 {{bibref|RFC2662}}.
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	 ...
	 * @return this instance
	 */
	public LastShowtime withTransmitBlocks(Long transmitBlocks) {
		this.transmitBlocks = transmitBlocks;
		return this;
	}

	/**
	 * Get the number of cell-delineation errors since the second most recent DSL Showtime (total seconds with NCD or LCD failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of cell-delineation errors since the second most recent DSL Showtime (total seconds with NCD or LCD failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	 ...
	 * @return this instance
	 */
	public LastShowtime withCellDelin(Long cellDelin) {
		this.cellDelin = cellDelin;
		return this;
	}

	/**
	 * Get the number of link-retrain errors since the second most recent DSL Showtime (Full Initialization Count as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of link-retrain errors since the second most recent DSL Showtime (Full Initialization Count as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	 ...
	 * @return this instance
	 */
	public LastShowtime withLinkRetrain(Long linkRetrain) {
		this.linkRetrain = linkRetrain;
		return this;
	}

	/**
	 * Get the number of initialization errors since the second most recent DSL Showtime (LINIT failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	...
	/**
	 * Set the number of initialization errors since the second most recent DSL Showtime (LINIT failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	 ...
	 * @return this instance
	 */
	public LastShowtime withInitErrors(Long initErrors) {
		this.initErrors = initErrors;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public LastShowtime withLinit(Boolean linit) {
		this.linit = linit;
		return this;
	}

	/**
	 * Get the number of initialization timeout errors since the second most recent DSL Showtime.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of initialization timeout errors since the second most recent DSL Showtime.
	 *
	 * @since 1.0
	 ...
	 * @return this instance
	 */
	public LastShowtime withInitTimeouts(Long initTimeouts) {
		this.initTimeouts = initTimeouts;
		return this;
	}

	/**
	 * Get the number of loss-of-framing errors since the second most recent DSL Showtime (LOF failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	...
	/**
	 * Set the number of loss-of-framing errors since the second most recent DSL Showtime (LOF failures as defined in ITU-T Rec. G.997.1).
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	 ...
	 * @return this instance
	 */
	public LastShowtime withLossOfFraming(Long lossOfFraming) {
		this.lossOfFraming = lossOfFraming;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public LastShowtime withLof(Boolean lof) {
		this.lof = lof;
		return this;
	}

	/**
	 * Get the number of errored seconds since the second most recent DSL Showtime (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of errored seconds since the second most recent DSL Showtime (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of errored seconds since the second most recent DSL Showtime detected by the ATU-C (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of errored seconds since the second most recent DSL Showtime detected by the ATU-C (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withAtuCErroredSecs(Long atuCErroredSecs) {
		this.atuCErroredSecs = atuCErroredSecs;
		return this;
	}

	/**
	 * Get the number of severely errored seconds since the second most recent DSL Showtime (SES-L as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of severely errored seconds since the second most recent DSL Showtime (SES-L as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of severely errored seconds since the second most recent DSL Showtime detected by the ATU-C (SES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of severely errored seconds since the second most recent DSL Showtime detected by the ATU-C (SES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withAtuCSeverelyErroredSecs(Long atuCSeverelyErroredSecs) {
		this.atuCSeverelyErroredSecs = atuCSeverelyErroredSecs;
		return this;
	}

	/**
	 * Get the number of FEC errors detected since the second most recent DSL Showtime (FEC-C as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of FEC errors detected since the second most recent DSL Showtime (FEC-C as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withFecErrors(Long fecErrors) {
		this.fecErrors = fecErrors;
		return this;
	}

	/**
	 * Get the number of FEC errors detected by the ATU-C since the second most recent DSL Showtime (FEC-CFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of FEC errors detected by the ATU-C since the second most recent DSL Showtime (FEC-CFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withAtuCFECErrors(Long atuCFECErrors) {
		this.atuCFECErrors = atuCFECErrors;
		return this;
	}

	/**
	 * Get the number of HEC errors detected since the second most recent DSL Showtime (HEC-P as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of HEC errors detected since the second most recent DSL Showtime (HEC-P as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withHecErrors(Long hecErrors) {
		this.hecErrors = hecErrors;
		return this;
	}

	/**
	 * Get the number of HEC errors detected by the ATU-C since the second most recent DSL Showtime (HEC-PFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of HEC errors detected by the ATU-C since the second most recent DSL Showtime (HEC-PFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withAtuCHECErrors(Long atuCHECErrors) {
		this.atuCHECErrors = atuCHECErrors;
		return this;
	}

	/**
	 * Get the number of CRC errors detected since the second most recent DSL Showtime (CV-C as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of CRC errors detected since the second most recent DSL Showtime (CV-C as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withCrcErrors(Long crcErrors) {
		this.crcErrors = crcErrors;
		return this;
	}

	/**
	 * Get the number of CRC errors detected by the ATU-C since the second most recent DSL Showtime (CV-CFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of CRC errors detected by the ATU-C since the second most recent DSL Showtime (CV-CFE as defined in ITU-T Rec. G.997.1). 
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public LastShowtime withAtuCCRCErrors(Long atuCCRCErrors) {
		this.atuCCRCErrors = atuCCRCErrors;
		return this;
	}
