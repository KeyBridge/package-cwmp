...
import org.broadbandforum.tr098.internetgatewaydevice.userinterface.LocalDisplay;
import org.broadbandforum.tr098.internetgatewaydevice.userinterface.RemoteAccess;
...
Indicates whether or not the CPE supports a user database that provides per-user passwords that can be used for accessing the local user interface.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "UserDatabaseSupported")
	public Boolean userDatabaseSupported;
	/**
	 * Present only if the CPE provides a password-protected LAN-side user interface.
...
If either UserDatabaseSupported or PasswordUserSelectable is {{false}}, the CPE MUST ignore the value of this parameter.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "SharedPassword")
	@CWMPParameter(access = "readWrite")
	public Boolean sharedPassword;
	/**
	 * Present only if the CPE provides a password-protected LAN-side user interface.
...
Indicates whether or not the CPE supports a user database that provides per-user passwords that can be used for accessing the local user interface.
	 ...
	 * @return the value
	 */
	public Boolean isUserDatabaseSupported() {
		return userDatabaseSupported;
	}
...
Indicates whether or not the CPE supports a user database that provides per-user passwords that can be used for accessing the local user interface.
	 *
	 * @since 1.4
	 * @param userDatabaseSupported the input value
	 */
	public void  setUserDatabaseSupported(Boolean userDatabaseSupported) {
		this.userDatabaseSupported = userDatabaseSupported;
	}
...
Indicates whether or not the CPE supports a user database that provides per-user passwords that can be used for accessing the local user interface.
	 ...
	 */
	public UserInterface withUserDatabaseSupported(Boolean userDatabaseSupported) {
		this.userDatabaseSupported = userDatabaseSupported;
		return this;
	}
...
If either UserDatabaseSupported or PasswordUserSelectable is {{false}}, the CPE MUST ignore the value of this parameter.
	 *
	 * @since 1.4
	 * @param sharedPassword the input value
	 */
...
If either UserDatabaseSupported or PasswordUserSelectable is {{false}}, the CPE MUST ignore the value of this parameter.
	 ...
	 * @return this instance
	 */
	public UserInterface withSharedPassword(Boolean sharedPassword) {
		this.sharedPassword = sharedPassword;
		return this;
	}
...
ISPLogoSize can also be used as a check to verify correct transfer and conversion of Base64 string to image size.
	...
	/**
	 * Get available user-interface languages, where each language is specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.4
	 * @return the value
	 */
	...
	/**
	 * Set available user-interface languages, where each language is specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.4
	...
	/**
	 * Get the current user-interface language, specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.4
	 * @return the value
	 */
	...
	/**
	 * Set the current user-interface language, specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.4
