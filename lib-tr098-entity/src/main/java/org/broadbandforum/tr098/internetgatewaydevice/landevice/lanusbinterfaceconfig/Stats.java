 ...
 */
package org.broadbandforum.tr098.internetgatewaydevice.landevice.lanusbinterfaceconfig;
...
@XmlType(name = "InternetGatewayDevice.LANDevice.LANUSBInterfaceConfig.Stats")
...
The value of this counter MAY be reset to zero when the CPE is rebooted.
	...
	/**
	 * Get the total number of packets (cells) transmitted out of the interface.
...
The value of this counter MAY be reset to zero when the CPE is rebooted.
	...
	/**
	 * Set the total number of packets (cells) transmitted out of the interface.
...
The value of this counter MAY be reset to zero when the CPE is rebooted.
	...
	/**
	 * Get the total number of packets (cells) which were received on this interface.
...
The value of this counter MAY be reset to zero when the CPE is rebooted.
	...
	/**
	 * Set the total number of packets (cells) which were received on this interface.
