...
import org.broadbandforum.tr098.internetgatewaydevice.upnp.device.Capabilities;
	 ...
	 * @since 1.5
	 */
@CWMPObject(name = "InternetGatewayDevice.UPnP.Device.")
@XmlRootElement(name = "Device")
@XmlType(name = "InternetGatewayDevice.UPnP.Device")
