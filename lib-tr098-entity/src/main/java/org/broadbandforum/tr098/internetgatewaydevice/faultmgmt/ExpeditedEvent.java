...
When a new alarm replaces an existing alarm, then all parameter values for that instance are considered as changed for the purposes of value change notifications to the ACS (even if their new values are identical to those of the prior alarm).
	 ...
	 * @since 1.10
	 */
@CWMPObject(name = "InternetGatewayDevice.FaultMgmt.ExpeditedEvent.{i}.")
@XmlRootElement(name = "ExpeditedEvent")
@XmlType(name = "InternetGatewayDevice.FaultMgmt.ExpeditedEvent")
@XmlAccessorType(XmlAccessType.FIELD)
public class ExpeditedEvent {
...
For an unpopulated entry, the value is the Unknown Time as defined in {{bibref|TR-106a4}}.
	 ...
	 */
	public ExpeditedEvent withEventTime(LocalDateTime eventTime) {
		this.eventTime = eventTime;
		return this;
	}
...
For an unpopulated entry, the value is {{empty}}.
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withAlarmIdentifier(String alarmIdentifier) {
		this.alarmIdentifier = alarmIdentifier;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withNotificationType(String notificationType) {
		this.notificationType = notificationType;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withManagedObjectInstance(String managedObjectInstance) {
		this.managedObjectInstance = managedObjectInstance;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withEventType(String eventType) {
		this.eventType = eventType;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withProbableCause(String probableCause) {
		this.probableCause = probableCause;
		return this;
	}
...
This is vendor defined and will be {{empty}} if the device doesn't support inclusion of this information.
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withSpecificProblem(String specificProblem) {
		this.specificProblem = specificProblem;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withPerceivedSeverity(String perceivedSeverity) {
		this.perceivedSeverity = perceivedSeverity;
		return this;
	}
...
This will be {{empty}} if the device doesn't support inclusion of this information.
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withAdditionalText(String additionalText) {
		this.additionalText = additionalText;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public ExpeditedEvent withAdditionalInformation(String additionalInformation) {
		this.additionalInformation = additionalInformation;
		return this;
	}
