...
public class AssociatedDevice {
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "LastDataTransmitRate")
	@CWMPParameter(activeNotify = "canDeny")
	@Size(max = 4)
	public String lastDataTransmitRate;
	...
	/**
	 * Get the data transmit rate that was most recently used for a station with a specified MAC address.
	 *
	 * @since 1.4
	 * @return the value
	 */
	public String getLastDataTransmitRate() {
		return lastDataTransmitRate;
	}

	/**
	 * Set the data transmit rate that was most recently used for a station with a specified MAC address.
	 *
	 * @since 1.4
	 * @param lastDataTransmitRate the input value
	 */
	public void  setLastDataTransmitRate(String lastDataTransmitRate) {
		this.lastDataTransmitRate = lastDataTransmitRate;
	}
	 ...
	 * @return this instance
	 */
	public AssociatedDevice withLastDataTransmitRate(String lastDataTransmitRate) {
		this.lastDataTransmitRate = lastDataTransmitRate;
		return this;
	}
