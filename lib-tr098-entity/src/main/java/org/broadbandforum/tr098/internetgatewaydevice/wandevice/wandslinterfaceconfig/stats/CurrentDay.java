...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of successfully received blocks during the current day, where a block is as defined in RFC 2662 {{bibref|RFC2662}}. 
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of successfully received blocks during the current day, where a block is as defined in RFC 2662 {{bibref|RFC2662}}. 
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Get the number of successfully transmitted blocks during the current day, where a block is as defined in RFC 2662 {{bibref|RFC2662}}. 
...
This parameter is DEPRECATED because it is not available at either the G or the S/T interface.
	...
	/**
	 * Set the number of successfully transmitted blocks during the current day, where a block is as defined in RFC 2662 {{bibref|RFC2662}}. 
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	 ...
	 * @return this instance
	 */
	public CurrentDay withLinit(Boolean linit) {
		this.linit = linit;
		return this;
	}
...
This parameter is DEPRECATED because it is not defined in G.997.1.
	 ...
	 * @return this instance
	 */
	public CurrentDay withLof(Boolean lof) {
		this.lof = lof;
		return this;
	}
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of errored seconds during the current day detected by the ATU-C (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of errored seconds during the current day detected by the ATU-C (ES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public CurrentDay withAtuCErroredSecs(Long atuCErroredSecs) {
		this.atuCErroredSecs = atuCErroredSecs;
		return this;
	}
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Get the number of severely errored seconds during the current day detected by the ATU-C (SES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	...
	/**
	 * Set the number of severely errored seconds during the current day detected by the ATU-C (SES-L as defined in ITU-T Rec. G.997.1).
...
Note: This parameter is OPTIONAL at the G and S/T interfaces in G.997.1 Amendment 1.  If the parameter is implemented but no value is available, its value MUST be 4294967295 (the maximum for its data type).
	 ...
	 * @return this instance
	 */
	public CurrentDay withAtuCSeverelyErroredSecs(Long atuCSeverelyErroredSecs) {
		this.atuCSeverelyErroredSecs = atuCSeverelyErroredSecs;
		return this;
	}
