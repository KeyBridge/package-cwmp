 ...
 */
package org.broadbandforum.tr098.internetgatewaydevice.landevice.lanhostconfigmanagement.dhcpconditionalservingpool;
...
Note that it is possible that an IP address in this table is present in the main pool and/or one or more of the other conditional serving pools, in which case it is possible that such an address will be assigned to a different client.
	 ...
	 * @since 1.4
	 */
@CWMPObject(name = "InternetGatewayDevice.LANDevice.{i}.LANHostConfigManagement.DHCPConditionalServingPool.{i}.DHCPStaticAddress.{i}.")
@XmlRootElement(name = "DHCPStaticAddress")
@XmlType(name = "InternetGatewayDevice.LANDevice.LANHostConfigManagement.DHCPConditionalServingPool.DHCPStaticAddress")
