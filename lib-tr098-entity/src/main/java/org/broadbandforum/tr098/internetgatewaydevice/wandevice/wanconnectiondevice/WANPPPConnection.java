...
import org.broadbandforum.tr098.internetgatewaydevice.wandevice.wanconnectiondevice.wanpppconnection.PortMapping;
import org.broadbandforum.tr098.internetgatewaydevice.wandevice.wanconnectiondevice.wanpppconnection.Stats;
...
When read, this parameter always returns {{false}}.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "PPPoESessionID")
	@Size(min = 1)
	public Long pppoESessionID;
	/**
...
This object is intended only for ''WANConnectionDevice''s that can support an Ethernet-layer on this interface (e.g., ''PPPoE'', ''IPoE'').
	 ...
	 * @return this instance
	 */
	public WANPPPConnection withAlias(Alias alias) {
		this.alias = alias;
		return this;
	}
...
When read, this parameter always returns {{false}}.
	 ...
	 * @return this instance
	 */
	public WANPPPConnection withReset(Boolean reset) {
		this.reset = reset;
		return this;
	}
	 ...
	 *
	 * @since 1.4
	 * @param pppoESessionID the input value
	 */
	public void  setPppoESessionID(Long pppoESessionID) {
	 ...
	 * @return this instance
	 */
	public WANPPPConnection withPppoESessionID(Long pppoESessionID) {
		this.pppoESessionID = pppoESessionID;
		return this;
	}

	/**
	 * Get the represents the IP Address of the remote end Default Gateway established through PPPoE.
	 *
	 * @since 1.4
	 * @return the value
	 */
	...
	/**
	 * Set the represents the IP Address of the remote end Default Gateway established through PPPoE.
	 *
	 * @since 1.4
	 ...
	 * @return this instance
	 */
	public WANPPPConnection withDefaultGateway(String defaultGateway) {
		this.defaultGateway = defaultGateway;
		return this;
	}
