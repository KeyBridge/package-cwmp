...
import org.broadbandforum.tr098.internetgatewaydevice.fap.gps.AGPSServerConfig;
import org.broadbandforum.tr098.internetgatewaydevice.fap.gps.ContinuousGPSStatus;
	 ...
	 * @since 1.10
	 */
@CWMPObject(name = "InternetGatewayDevice.FAP.GPS.")
@XmlRootElement(name = "GPS")
@XmlType(name = "InternetGatewayDevice.FAP.GPS")
