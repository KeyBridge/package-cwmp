...
If {{empty}} is specified, the CPE MUST use the default routing interface.
	...
	/**
	 * Get the URL, as defined in {{bibref|RFC3986}}, for the CPE to perform the download on. This parameter MUST be in the form of a valid HTTP {{bibref|RFC2616}} or FTP {{bibref|RFC862}} URL.
...
When using HTTP transport the HTTP Authentication MUST NOT be used.
	...
	/**
	 * Set the URL, as defined in {{bibref|RFC3986}}, for the CPE to perform the download on. This parameter MUST be in the form of a valid HTTP {{bibref|RFC2616}} or FTP {{bibref|RFC862}} URL.
