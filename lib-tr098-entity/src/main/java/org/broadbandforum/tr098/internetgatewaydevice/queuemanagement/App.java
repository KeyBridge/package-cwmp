...
{{param}} and {{param|AppDefaultQueue}} MUST NOT both be specified.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "AppDefaultTrafficClass")
	@CWMPParameter(access = "readWrite")
	@Size(min = -1)
	public Integer appDefaultTrafficClass = -1;
	/**
...
{{param}} and {{param|AppDefaultQueue}} MUST NOT both be specified.
	 ...
	 * @return the value
	 */
	public Integer getAppDefaultTrafficClass() {
		return appDefaultTrafficClass;
	}
...
{{param}} and {{param|AppDefaultQueue}} MUST NOT both be specified.
	 *
	 * @since 1.4
	 * @param appDefaultTrafficClass the input value
	 */
	public void  setAppDefaultTrafficClass(Integer appDefaultTrafficClass) {
		this.appDefaultTrafficClass = appDefaultTrafficClass;
	}
...
{{param}} and {{param|AppDefaultQueue}} MUST NOT both be specified.
	 ...
	 * @return this instance
	 */
	public App withAppDefaultTrafficClass(Integer appDefaultTrafficClass) {
		this.appDefaultTrafficClass = appDefaultTrafficClass;
		return this;
	}
