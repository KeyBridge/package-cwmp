...
This parameter is OBSOLETED because it serves no purpose (no other parameter references it).
	...
	public Boolean classificationEnable = false;
	/**
...
The {{enum|Error}} value MAY be used by the CPE to indicate a locally defined error condition.
	...
	public String classificationStatus = "Disabled";
	/**
	 * {{datatype|expand}}
	 *
	 * @since 1.9
...
{{empty}} indicates this criterion is not used for classification.
	...
	@CWMPParameter(access = "readWrite")
	@Size(max = 256)
	public String sourceVendorSpecificInfo;
	/**
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "SourceVendorSpecificInfoMode")
	@CWMPParameter(access = "readWrite")
	public String sourceVendorSpecificInfoMode = "Exact";
	/**
	 * Classification criterion. 
...
{{empty}} indicates this criterion is not used for classification.
	...
	@CWMPParameter(access = "readWrite")
	@Size(max = 256)
	public String destVendorSpecificInfo;
	/**
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	 ...
	 * @since 1.4
	 */
	@XmlElement(name = "DestVendorSpecificInfoMode")
	@CWMPParameter(access = "readWrite")
	public String destVendorSpecificInfoMode = "Exact";
	/**
	 * Classification criterion.
...
If {{true}}, the class includes all packets except those destined for LAN devices that match the DestVendorClassID entry, if specified.
	...
	/**
	 * Get the destVendorClassID pattern match criterion.  {{enum}}
...
For example, if {{param|DestVendorClassID}} is "Example" then an Option 60 value of "Example device" will match with {{param}} values of {{enum|Prefix}} or {{enum|Substring}}, but not with {{enum|Exact}} or {{enum|Suffix}}.
	...
	/**
	 * Set the destVendorClassID pattern match criterion.  {{enum}}
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 * @return the value
	 */
	public String getSourceVendorSpecificInfo() {
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 */
	public void  setSourceVendorSpecificInfo(String sourceVendorSpecificInfo) {
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 * @return this instance
	 */
	public Classification withSourceVendorSpecificInfo(String sourceVendorSpecificInfo) {
		this.sourceVendorSpecificInfo = sourceVendorSpecificInfo;
		return this;
	}
...
If {{true}}, the class includes all packets except those sourced from LAN devices that match the {{param|SourceVendorSpecificInfo}} entry, if specified.
	...
	/**
	 * Get the {{param|SourceVendorSpecificInfo}} Enterprise Number as defined in RFC 3925 {{bibref|RFC3925}}.
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	...
	/**
	 * Set the {{param|SourceVendorSpecificInfo}} Enterprise Number as defined in RFC 3925 {{bibref|RFC3925}}.
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	...
	/**
	 * Get the {{param|SourceVendorSpecificInfo}} Sub Option Code as defined in RFC 3925 {{bibref|RFC3925}}.
	 *
	 * @since 1.4
	 * @return the value
	 */
	...
	/**
	 * Set the {{param|SourceVendorSpecificInfo}} Sub Option Code as defined in RFC 3925 {{bibref|RFC3925}}.
	 *
	 * @since 1.4
	...
	/**
	 * Get the {{param|SourceVendorSpecificInfo}} pattern match criterion.
	 *
	 * @since 1.4
	 * @return the value
	 */
	public String getSourceVendorSpecificInfoMode() {
		return sourceVendorSpecificInfoMode;
	}

	/**
	 * Set the {{param|SourceVendorSpecificInfo}} pattern match criterion.
	 *
	 * @since 1.4
	 * @param sourceVendorSpecificInfoMode the input value
	 */
	public void  setSourceVendorSpecificInfoMode(String sourceVendorSpecificInfoMode) {
		this.sourceVendorSpecificInfoMode = sourceVendorSpecificInfoMode;
	}
	 ...
	 * @return this instance
	 */
	public Classification withSourceVendorSpecificInfoMode(String sourceVendorSpecificInfoMode) {
		this.sourceVendorSpecificInfoMode = sourceVendorSpecificInfoMode;
		return this;
	}
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 * @return the value
	 */
	public String getDestVendorSpecificInfo() {
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 */
	public void  setDestVendorSpecificInfo(String destVendorSpecificInfo) {
...
{{empty}} indicates this criterion is not used for classification.
	 ...
	 * @return this instance
	 */
	public Classification withDestVendorSpecificInfo(String destVendorSpecificInfo) {
		this.destVendorSpecificInfo = destVendorSpecificInfo;
		return this;
	}
...
If {{true}}, the class includes all packets except those destined for LAN devices that match the {{param|DestVendorSpecificInfo}} entry, if specified.
	...
	/**
	 * Get the {{param|DestVendorSpecificInfo}} Enterprise Number as defined in RFC 3925 {{bibref|RFC3925}}.
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	...
	/**
	 * Set the {{param|DestVendorSpecificInfo}} Enterprise Number as defined in RFC 3925 {{bibref|RFC3925}}.
...
The default value (0) is assigned to IANA and will probably need to be replaced with an appropriate enterprise number.
	...
	/**
	 * Get the {{param|DestVendorSpecificInfo}} Sub Option Code as defined in RFC 3925 {{bibref|RFC3925}}.
	 *
	 * @since 1.4
	 * @return the value
	 */
	...
	/**
	 * Set the {{param|DestVendorSpecificInfo}} Sub Option Code as defined in RFC 3925 {{bibref|RFC3925}}.
	 *
	 * @since 1.4
	...
	/**
	 * Get the {{param|DestVendorSpecificInfo}} pattern match criterion.
	 *
	 * @since 1.4
	 * @return the value
	 */
	public String getDestVendorSpecificInfoMode() {
		return destVendorSpecificInfoMode;
	}

	/**
	 * Set the {{param|DestVendorSpecificInfo}} pattern match criterion.
	 *
	 * @since 1.4
	 * @param destVendorSpecificInfoMode the input value
	 */
	public void  setDestVendorSpecificInfoMode(String destVendorSpecificInfoMode) {
		this.destVendorSpecificInfoMode = destVendorSpecificInfoMode;
	}
	 ...
	 * @return this instance
	 */
	public Classification withDestVendorSpecificInfoMode(String destVendorSpecificInfoMode) {
		this.destVendorSpecificInfoMode = destVendorSpecificInfoMode;
		return this;
	}
