...
import org.broadbandforum.annotation.CWMPObject;
	 ...
	 * @since 1.9
	 */
@CWMPObject(name = "InternetGatewayDevice.ManagementServer.EmbeddedDevice.{i}.")
@XmlRootElement(name = "EmbeddedDevice")
@XmlType(name = "InternetGatewayDevice.ManagementServer.EmbeddedDevice")
...
This is an opaque string that is unique to the Proxied Device within a specific sub-network within the LAN (identified by the {{param|ControllerID}}).  If the {{param|ControllerID}} is {{empty}} this {{param}} is unique across the LAN.
	...
	/**
	 * Get the references the {{object|.LANDevice.{i}.Hosts.Host}} table entry(s), whether active or inactive, that corresponds to this proxied LAN device.
	 *
	 * @since 1.9
	 * @return the value
	 */
	...
	/**
	 * Set the references the {{object|.LANDevice.{i}.Hosts.Host}} table entry(s), whether active or inactive, that corresponds to this proxied LAN device.
	 *
	 * @since 1.9
