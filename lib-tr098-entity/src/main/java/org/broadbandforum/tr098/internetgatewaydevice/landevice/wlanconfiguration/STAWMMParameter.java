...
For example, if ECWMax is 8, then CWMax is 2^8 - 1, or 255,
	 ...
	 */
	public STAWMMParameter withAlias(Alias alias) {
		this.alias = alias;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public STAWMMParameter withAifSN(Long aifSN) {
		this.aifSN = aifSN;
		return this;
	}
...
For example, if ECWMin is 8, then CWMin is 2^8 - 1, or 255,
	 ...
	 * @return this instance
	 */
	public STAWMMParameter withEcwMin(Long ecwMin) {
		this.ecwMin = ecwMin;
		return this;
	}
...
For example, if ECWMax is 8, then CWMax is 2^8 - 1, or 255,
	 ...
	 * @return this instance
	 */
	public STAWMMParameter withEcwMax(Long ecwMax) {
		this.ecwMax = ecwMax;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public STAWMMParameter withTxoP(Long txoP) {
		this.txoP = txoP;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public STAWMMParameter withAckPolicy(Boolean ackPolicy) {
		this.ackPolicy = ackPolicy;
		return this;
	}
