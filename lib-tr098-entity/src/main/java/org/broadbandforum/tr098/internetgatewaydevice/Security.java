...
import org.broadbandforum.tr098.internetgatewaydevice.security.Certificate;
	 ...
	 * @since 1.10
	 */
@CWMPObject(name = "InternetGatewayDevice.Security.")
@XmlRootElement(name = "Security")
@XmlType(name = "InternetGatewayDevice.Security")
