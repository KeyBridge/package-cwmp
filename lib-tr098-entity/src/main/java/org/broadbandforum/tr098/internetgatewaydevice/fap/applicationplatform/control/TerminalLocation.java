...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since 1.10
	 */
@CWMPObject(name = "InternetGatewayDevice.FAP.ApplicationPlatform.Control.TerminalLocation.")
@XmlRootElement(name = "TerminalLocation")
@XmlType(name = "InternetGatewayDevice.FAP.ApplicationPlatform.Control.TerminalLocation")
