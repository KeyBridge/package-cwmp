...
import org.broadbandforum.annotation.CWMPObject;
	 ...
	 * @since 1.5
	 */
@CWMPObject(name = "InternetGatewayDevice.DeviceInfo.NetworkProperties.")
@XmlRootElement(name = "NetworkProperties")
@XmlType(name = "InternetGatewayDevice.DeviceInfo.NetworkProperties")
