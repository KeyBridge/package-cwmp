...
@XmlRootElement(name = "WANDSLLinkConfig")
...
This refers to CRC errors at the ATM adaptation layer (AAL). The AAL in use is indicated by the {{param|ATMAAL}} parameter. The value of the {{param}} parameter MUST be 0 for AAL types that have no CRCs.
	...
	/**
	 * Get the indicates the type of DSL connection and refers to the complete stack of protocol used for this connection.  {{enum}}
...
The value {{enum|PPPoE}} has always been DEPRECATED and {{enum|EoA}} SHOULD be used instead (see {{bibref|TR-098a2|Annex B}}).  The ACS MUST NOT set this parameter to {{enum|PPPoE}} and the CPE MUST reject attempts to do so.
	...
	/**
	 * Set the indicates the type of DSL connection and refers to the complete stack of protocol used for this connection.  {{enum}}
...
The "PVC:" or "SVC:" prefix is part of the parameter value and MUST be followed by 0 or 1 space characters.  For example, possible values for this parameter are "PVC:8/23" or "PVC: 0/35".
	...
	/**
	 * Get the this flag tells if a checksum SHOULD be added in the ATM payload. It does not refer to the checksum of one of the ATM cells or AALX packets. In case of LLC or VCMUX encapsulation, this ATM checksum is the FCS field described in RFC 2684 {{bibref|RFC2684}}. It is only applicable in the upstream direction.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the this flag tells if a checksum SHOULD be added in the ATM payload. It does not refer to the checksum of one of the ATM cells or AALX packets. In case of LLC or VCMUX encapsulation, this ATM checksum is the FCS field described in RFC 2684 {{bibref|RFC2684}}. It is only applicable in the upstream direction.
	 *
	 * @since 1.0
	...
	/**
	 * Get the ordered list of VPI/VCI pairs to search if a link using the {{param|DestinationAddress}} cannot be established.  In the form:
...
: ''0/35, 8/35, 1/35''
	...
	/**
	 * Set the ordered list of VPI/VCI pairs to search if a link using the {{param|DestinationAddress}} cannot be established.  In the form:
...
: ''0/35, 8/35, 1/35''
	...
	/**
	 * Get the current count of successfully transmitted cells.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the current count of successfully transmitted cells.
	 *
	 * @since 1.0
	...
	/**
	 * Get the current count of successfully received cells.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the current count of successfully received cells.
	 *
	 * @since 1.0
...
This parameter is DEPRECATED because it overlaps with the {{param|ATMCRCErrors}} parameter. If present, it MUST have the same value as the {{param|ATMCRCErrors}} parameter if AAL5 is in use, or 0 if AAL5 is not in use.
	...
	/**
	 * Get the count of the ATM layer cyclic redundancy check (CRC) errors.
...
This refers to CRC errors at the ATM adaptation layer (AAL). The AAL in use is indicated by the {{param|ATMAAL}} parameter. The value of the {{param}} parameter MUST be 0 for AAL types that have no CRCs.
	...
	/**
	 * Set the count of the ATM layer cyclic redundancy check (CRC) errors.
