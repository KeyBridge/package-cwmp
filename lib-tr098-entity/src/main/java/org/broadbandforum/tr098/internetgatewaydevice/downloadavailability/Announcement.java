...
import org.broadbandforum.tr098.internetgatewaydevice.downloadavailability.announcement.Group;
	 ...
	 * @since 1.5
	 */
@CWMPObject(name = "InternetGatewayDevice.DownloadAvailability.Announcement.")
@XmlRootElement(name = "Announcement")
@XmlType(name = "InternetGatewayDevice.DownloadAvailability.Announcement")
