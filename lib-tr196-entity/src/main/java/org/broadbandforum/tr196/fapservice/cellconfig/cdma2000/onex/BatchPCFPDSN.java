...
import org.broadbandforum.common.IPAddress;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.CellConfig.CDMA2000.OneX.BatchPCFPDSN.{i}.", uniqueConstraints = {@CWMPUnique(names = {"BatchTableNumber"}),
...
public class BatchPCFPDSN {
	...
	/**
	 * Get the BatchTable Number should be given only once during the creation of a Batch Table. This is the Key Attribute that uniquely identifies a BatchTable entry. This number indicates the index of this batch to determine the PDSN number in the PDSN selection algorithm ({{bibref|3GPP2-A.S0013}}).
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the BatchTable Number should be given only once during the creation of a Batch Table. This is the Key Attribute that uniquely identifies a BatchTable entry. This number indicates the index of this batch to determine the PDSN number in the PDSN selection algorithm ({{bibref|3GPP2-A.S0013}}).
	 *
	 * @since 2.0
	...
	/**
	 * Get the ios Version of this PDSN.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the ios Version of this PDSN.
	 *
	 * @since 2.0
