 ...
 */
package org.broadbandforum.tr196.fapservice.rem.cdma2000.hrpd;
...
import org.broadbandforum.tr196.fapservice.rem.cdma2000.hrpd.cell.ControlChannel;
import org.broadbandforum.tr196.fapservice.rem.cdma2000.hrpd.cell.RF;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.REM.CDMA2000.HRPD.Cell.{i}.")
@XmlRootElement(name = "FAPService.REM.CDMA2000.HRPD.Cell")
@XmlType(name = "FAPService.REM.CDMA2000.HRPD.Cell")
...
public class Cell {
	...
	/**
	 * Get the table containing information braodcast on control channel.
	 *
	 * @return the value
	 */
	...
	/**
	 * Set the table containing information braodcast on control channel.
	 *
