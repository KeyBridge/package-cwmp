...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.CellConfig.CDMA2000.HRPD.Redirect.")
@XmlRootElement(name = "FAPService.CellConfig.CDMA2000.HRPD.Redirect")
@XmlType(name = "FAPService.CellConfig.CDMA2000.HRPD.Redirect")
...
public class Redirect {
	...
	/**
	 * Get the channel number set from ACS that the FAP uses to redirect the AT in case of closed access or when exceeding session capacity. The ACS shall push this if the the operator has provided this information in a configuration file. If this is not configured, the FAP rejects the AT. The supported range is 0..2047.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the channel number set from ACS that the FAP uses to redirect the AT in case of closed access or when exceeding session capacity. The ACS shall push this if the the operator has provided this information in a configuration file. If this is not configured, the FAP rejects the AT. The supported range is 0..2047.
	 *
	 * @since 2.0
	...
	/**
	 * Get the bandclass set from ACS that the FAP uses to redirect the AT incase of closed access or when exceeding session capacity. The ACS shall push this if the the operator has provided this information in a configuration file. If this is not configured, the FAP rejects the AT. The supported range is 0..9.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the bandclass set from ACS that the FAP uses to redirect the AT incase of closed access or when exceeding session capacity. The ACS shall push this if the the operator has provided this information in a configuration file. If this is not configured, the FAP rejects the AT. The supported range is 0..9.
	 *
	 * @since 2.0
