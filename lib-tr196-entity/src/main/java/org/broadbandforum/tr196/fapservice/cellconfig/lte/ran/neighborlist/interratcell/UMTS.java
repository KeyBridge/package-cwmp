...
import org.broadbandforum.common.Alias;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.CellConfig.LTE.RAN.NeighborList.InterRATCell.UMTS.{i}.", uniqueConstraints = {@CWMPUnique(names = {"PLMNID", "CID"}),
...
{{bibref|3GPP-TS.32.642|Section 6.3.11}} {{bibref|3GPP-TS.25.433|Section 2.2.33}}
	 ...
	 */
	public UMTS withEnable(Boolean enable) {
		this.enable = enable;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public UMTS withAlias(Alias alias) {
		this.alias = alias;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public UMTS withMustInclude(Boolean mustInclude) {
		this.mustInclude = mustInclude;
		return this;
	}
