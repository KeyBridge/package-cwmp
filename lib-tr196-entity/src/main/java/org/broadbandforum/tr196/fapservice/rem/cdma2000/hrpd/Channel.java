...
import org.broadbandforum.common.Alias;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.REM.CDMA2000.HRPD.Channel.{i}.", uniqueConstraints = {@CWMPUnique(names = {"SniffingBandClass", "SniffingChannelNumber", "PNList"}),
...
public class Channel {
	...
	/**
	 * Get the Radio Frequency Channel Number (RFCN) in the FL direction.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the Radio Frequency Channel Number (RFCN) in the FL direction.
	 *
	 * @since 2.0
