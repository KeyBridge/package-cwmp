...
import org.broadbandforum.common.Alias;
	 ...
	 * @since TR196 v2.0
	 */
@CWMPObject(name = "FAPService.{i}.CellConfig.UMTS.RAN.InterRATMeas.Instance.{i}.", uniqueConstraints = {@CWMPUnique(names = {"Alias"}, functional = false),
	@CWMPUnique(names = {"InterRATEventIdentity"})})
