...
import org.broadbandforum.tr196.fapservice.cellconfig.lte.ran.drb.Stats;
...
public class DRB {
	...
	/**
	 * Get the this object provides the DRB statistics as defined in {{bibref|3GPP-TS.32.453}}.
	 *
	 * @return the value
	 */
	...
	/**
	 * Set the this object provides the DRB statistics as defined in {{bibref|3GPP-TS.32.453}}.
	 *
	 ...
	 */
	public DRB withStats(Stats stats) {
		this.stats = stats;
		return this;
	}
