...
public class RF {
	...
	/**
	 * The strength estimate of the received pilot energy per chip, Ecp, in dBm.
	 *
	 * @since 2.0
	 */
	...
	/**
	 * Get the strength estimate of the received pilot energy per chip, Ecp, in dBm.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the strength estimate of the received pilot energy per chip, Ecp, in dBm.
	 *
	 * @since 2.0
	...
	/**
	 * Get the if set to {{true}}, the overhead messages for this particular cell is included in {{object|.REM.CDMA2000.OneX.Cell.{i}.ControlChannel.}}.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the if set to {{true}}, the overhead messages for this particular cell is included in {{object|.REM.CDMA2000.OneX.Cell.{i}.ControlChannel.}}.
	 *
	 * @since 2.0
