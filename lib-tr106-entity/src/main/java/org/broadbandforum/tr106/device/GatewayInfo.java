...
public class GatewayInfo {
	...
	/**
	 * Get the organizationally unique identifier of the associated Internet Gateway Device.  {{empty}} indicates that there is no associated Internet Gateway Device that has been detected.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the organizationally unique identifier of the associated Internet Gateway Device.  {{empty}} indicates that there is no associated Internet Gateway Device that has been detected.
	 *
	 * @since 1.0
