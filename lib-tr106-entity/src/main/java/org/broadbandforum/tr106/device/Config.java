...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since 1.0
	 */
@CWMPObject(name = "Device.Config.")
@XmlRootElement(name = "Device.Config")
@XmlType(name = "Device.Config")
...
An alternative to this parameter, e.g. when the configuration file is larger than the parameter size limit, is to use the Upload and Download RPCs with a FileType of ''1 Vendor Configuration File''.
	 ...
	 */
	public Config withPersistentData(String persistentData) {
		this.persistentData = persistentData;
		return this;
	}
...
An alternative to this parameter, e.g. when the configuration file is larger than the parameter size limit, is to use the Upload and Download RPCs with a FileType of ''1 Vendor Configuration File''.
	 ...
	 * @return this instance
	 */
	public Config withConfigFile(String configFile) {
		this.configFile = configFile;
		return this;
	}
