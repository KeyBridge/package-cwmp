...
ISPLogoSize can also be used as a check to verify correct transfer and conversion of Base64 string to image size.
	...
	/**
	 * Get the comma-separated list of user-interface languages that are available, where each language is specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the comma-separated list of user-interface languages that are available, where each language is specified according to RFC 3066 {{bibref|RFC3066}}.
	 *
	 * @since 1.0
