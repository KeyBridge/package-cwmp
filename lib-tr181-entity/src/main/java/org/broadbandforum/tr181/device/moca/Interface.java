 ...
 * {{bibref|TR-181i2|Section 4.2}}). Each table entry models the PHY and MAC
 * levels of a MoCA interface {{bibref|MoCAv1.0}} {{bibref|MoCAv1.1}}.
 *
 * @since TR181 v2.0
 */
@CWMPObject(name = "Device.MoCA.Interface.{i}.", uniqueConstraints = {
...
public class Interface {
  ...
  public String name;
  /**
   * The accumulated time in seconds since the interface entered its current
   * operational state.
   *
   * @since 2.0
   */
   ...
   * modeled via the {{param|.Ethernet.Link.{i}.MACAddress}} parameter.
   *
   * @since 2.0
   */
  ...
  /**
   * The maximum bandwidth of this interface for flows onto the MoCA network in
   * Mbps.
   * <p>
  ...
  /**
   * The maximum bandwidth of this interface for flows from the MoCA network in
   * Mbps.
   * <p>
   ...
   * <p>
   * This element MUST be in the form of dot-delimited integers, where each
   * successive integer represents a more minor category of variation. For
   * example, 1.0, where the components mean major.minor revision number.
   * {{pattern}}
   * <p>
   ...
   * {{param}} is {{true}} then the interface supports 16 nodes (the maximum for
   * a MoCA 1.1 network). If {{param}} is false then the interface supports 8
   * nodes (the maximum for a MoCA 1.0 network).
   *
   * @since 2.0
   */
  ...
  /**
   * The configured privacy mode. This indicates whether link-layer security is
   * enabled ({{true}}) or disabled ({{false}}) for network admission.
   * <p>
   * The configured privacy setting MAY NOT match the current operational state
   * ({{param|PrivacyEnabled}}), since this setting is only applied during
   * network formation or admission.
   *
   * @since 2.0
   */
  ...
  /**
   * Hexadecimal encoded 64-bit mask of supported frequencies. This is the bit
   * map of the spectrum that the interface supports, and each bit represents 25
   * MHz of spectrum. The least significant bit of the rightmost character
   * corresponds to 800MHz, which is the lowest frequency.
   * <p>
   * For example, an interface that supports 1150 MHz through 1500 MHz would
   * have a value of 0x000000001FFFC000.
   * <p>
   * This parameter is based on ''mocaIfCapabilityMask'' from
   * {{bibref|MOCA11-MIB}}.
   *
   * @since 2.0
   */
  ...
  /**
   * The configured hexadecimal encoded 64-bit mask of enabled frequencies for
   * network admission.
   * <p>
   * The configured frequencies MAY NOT match the current operational state
   * ({{param|FreqCurrentMask}}), since this setting is only applied during
   * network formation or admission.
   *
   * @since 2.0
   */
  ...
  /**
   * Hexadecimal encoded 64-bit mask of used frequencies. This is the bit map of
   * the spectrum that can be used and is a subset of the
   * {{param|FreqCapabilityMask}}. Each bit represents 25 MHz of spectrum. The
   * least significant bit of the rightmost character corresponds to 800MHz,
  ...
  /**
   * Current Operational Frequency. The RF frequency in Hz to which the MoCA
   * interface is currently tuned. This parameter is only valid when
   ...
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
   * {{param|Enable}} is {{true}} then this change might take several minutes to
   * complete.
   * <p>
  ...
  /**
   * Beacon Transmit Power attenuation in dB relative to the maximum transmit
   * power.
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
  ...
  /**
   * Hexadecimal encoded 64-bit mask of MoCA taboo channels identified for the
   * home network. This is the bit map of the spectrum that the interface
   * supports, and each bit represents 25 MHz of spectrum. The least significant
   * bit of the rightmost character corresponds to 800MHz, which is the lowest
   * frequency.
   * <p>
   * This parameter is based on ''mocaIfTabooChannelMask'' from
   * {{bibref|MOCA11-MIB}}.
   *
   * @since 2.0
   */
   ...
   * corresponds to 800MHz, which is the lowest frequency.
   * <p>
   * This parameter is based on ''mocaIfNodeTabooChannelMask'' from
   * {{bibref|MOCA11-MIB}}.
   *
   * @since 2.0
   */
  ...
  /**
   * Transmit Power attenuation in dB relative to the maximum transmit power for
  ...
  /**
   * The packet aggregation capability supported by the interface. Standard
  ...
  /**
   * Get the current operational state of the interface (see
   * {{bibref|TR-181i2|Section 4.2.2}}). {{enum}}
   * <p>
   * When {{param|Enable}} is {{false}} then {{param}} SHOULD normally be
   * {{enum|Down}} (or {{enum|NotPresent}} or {{enum|Error}} if there is a fault
  ...
  /**
   * Set the current operational state of the interface (see
   * {{bibref|TR-181i2|Section 4.2.2}}). {{enum}}
   * <p>
   * When {{param|Enable}} is {{false}} then {{param}} SHOULD normally be
   * {{enum|Down}} (or {{enum|NotPresent}} or {{enum|Error}} if there is a fault
  ...
  /**
   * Get the accumulated time in seconds since the interface entered its current
   * operational state.
   *
   * @since 2.0
   * @return the value
  ...
  /**
   * Set the accumulated time in seconds since the interface entered its current
   * operational state.
   *
   * @since 2.0
  ...
  /**
   * Get the maximum bandwidth of this interface for flows onto the MoCA network
   * in Mbps.
   * <p>
   * This parameter is based on ''mocaIfMaxIngressNodeBw'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Set the maximum bandwidth of this interface for flows onto the MoCA network
   * in Mbps.
   * <p>
   * This parameter is based on ''mocaIfMaxIngressNodeBw'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Get the maximum bandwidth of this interface for flows from the MoCA network
   * in Mbps.
   * <p>
   * This parameter is based on ''mocaIfMaxEgressNodeBw'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Set the maximum bandwidth of this interface for flows from the MoCA network
   * in Mbps.
   * <p>
   * This parameter is based on ''mocaIfMaxEgressNodeBw'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Get the identifies the MoCA version that the MoCA network is currently
   * running.
   * <p>
   * This element MUST be in the form of dot-delimited integers, where each
   * successive integer represents a more minor category of variation. For
  ...
  /**
   * Set the identifies the MoCA version that the MoCA network is currently
   * running.
   * <p>
   * This element MUST be in the form of dot-delimited integers, where each
   * successive integer represents a more minor category of variation. For
  ...
  /**
   * Get the Node ID of the current Network Coordinator (NC) for the MoCA
   * network.
   * <p>
   * This parameter is based on ''mocaIfNC'' from {{bibref|MOCA11-MIB}}.
   *
  ...
  /**
   * Set the Node ID of the current Network Coordinator (NC) for the MoCA
   * network.
   * <p>
   * This parameter is based on ''mocaIfNC'' from {{bibref|MOCA11-MIB}}.
   *
  ...
  /**
   * Get the maximum network node capability supported by the interface. If
   * {{param}} is {{true}} then the interface supports 16 nodes (the maximum for
   * a MoCA 1.1 network). If {{param}} is false then the interface supports 8
   * nodes (the maximum for a MoCA 1.0 network).
   *
  ...
  /**
   * Set the maximum network node capability supported by the interface. If
   * {{param}} is {{true}} then the interface supports 16 nodes (the maximum for
   * a MoCA 1.1 network). If {{param}} is false then the interface supports 8
   * nodes (the maximum for a MoCA 1.0 network).
   *
  ...
  /**
   * Get the configured privacy mode. This indicates whether link-layer security
   * is enabled ({{true}}) or disabled ({{false}}) for network admission.
   * <p>
   * The configured privacy setting MAY NOT match the current operational state
   * ({{param|PrivacyEnabled}}), since this setting is only applied during
   * network formation or admission.
  ...
  /**
   * Set the configured privacy mode. This indicates whether link-layer security
   * is enabled ({{true}}) or disabled ({{false}}) for network admission.
   * <p>
   * The configured privacy setting MAY NOT match the current operational state
   * ({{param|PrivacyEnabled}}), since this setting is only applied during
  ...
  /**
   * Get the hexadecimal encoded 64-bit mask of supported frequencies. This is
   * the bit map of the spectrum that the interface supports, and each bit
   * represents 25 MHz of spectrum. The least significant bit of the rightmost
  ...
  /**
   * Set the hexadecimal encoded 64-bit mask of supported frequencies. This is
   * the bit map of the spectrum that the interface supports, and each bit
   * represents 25 MHz of spectrum. The least significant bit of the rightmost
   * character corresponds to 800MHz, which is the lowest frequency.
   * <p>
  ...
  /**
   * Get the configured hexadecimal encoded 64-bit mask of enabled frequencies
  ...
  /**
   * Set the configured hexadecimal encoded 64-bit mask of enabled frequencies
   * for network admission.
   * <p>
   * The configured frequencies MAY NOT match the current operational state
   * ({{param|FreqCurrentMask}}), since this setting is only applied during
  ...
  /**
   * Get the hexadecimal encoded 64-bit mask of used frequencies. This is the
   * bit map of the spectrum that can be used and is a subset of the
   * {{param|FreqCapabilityMask}}. Each bit represents 25 MHz of spectrum. The
   * least significant bit of the rightmost character corresponds to 800MHz,
   * which is the lowest frequency.
   * <p>
  ...
  /**
   * Set the hexadecimal encoded 64-bit mask of used frequencies. This is the
   * bit map of the spectrum that can be used and is a subset of the
   * {{param|FreqCapabilityMask}}. Each bit represents 25 MHz of spectrum. The
   * least significant bit of the rightmost character corresponds to 800MHz,
   * which is the lowest frequency.
  ...
  /**
   * Get the current Operational Frequency. The RF frequency in Hz to which the
  ...
  /**
   * Set the current Operational Frequency. The RF frequency in Hz to which the
   * MoCA interface is currently tuned. This parameter is only valid when
   * {{param|Status}} is {{enum|Up|Status}}.
   * <p>
   * This parameter is based on ''mocaIfRFChannel'' from {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Get the last Operational Frequency. The RF frequency in Hz to which the
   * MoCA interface was tuned when last in the {{enum|Up|Status}} state.
   * <p>
   * This parameter is based on ''mocaIfLOF'' from {{bibref|MOCA11-MIB}}.
   *
   * @since 2.0
  ...
  /**
   * Set the last Operational Frequency. The RF frequency in Hz to which the
   * MoCA interface was tuned when last in the {{enum|Up|Status}} state.
   * <p>
   * This parameter is based on ''mocaIfLOF'' from {{bibref|MOCA11-MIB}}.
   *
  ...
  /**
   * Set the mocA Password. The value consists of numeric characters (0-9).
   * {{pattern}}
   * <p>
   * This parameter is based on ''mocaIfPassword'' from {{bibref|MOCA11-MIB}}.
   *
  ...
  /**
   * Get the transmit Power attenuation in dB relative to the maximum transmit
   * power.
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
  ...
  /**
   * Set the transmit Power attenuation in dB relative to the maximum transmit
   * power.
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
  ...
  /**
   * Get the beacon Transmit Power attenuation in dB relative to the maximum
   * transmit power.
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
  ...
  /**
   * Set the beacon Transmit Power attenuation in dB relative to the maximum
   * transmit power.
   * <p>
   * The MoCA interface SHOULD have {{param|Enable}} set to {{false}} for any
   * change in this configuration. If the parameter is modified when
  ...
  /**
   * Get the hexadecimal encoded 64-bit mask of MoCA taboo channels identified
   * for the home network. This is the bit map of the spectrum that the
   * interface supports, and each bit represents 25 MHz of spectrum. The least
   * significant bit of the rightmost character corresponds to 800MHz, which is
  ...
  /**
   * Set the hexadecimal encoded 64-bit mask of MoCA taboo channels identified
   * for the home network. This is the bit map of the spectrum that the
   * interface supports, and each bit represents 25 MHz of spectrum. The least
   * significant bit of the rightmost character corresponds to 800MHz, which is
   * the lowest frequency.
  ...
  /**
   * Get the transmit Power attenuation in dB relative to the maximum transmit
   * power for broadcast transmissions.
   * <p>
   * This parameter is based on ''mocaIfTxGcdPowerReduction'' from
   * {{bibref|MOCA11-MIB}}.
   *
  ...
  /**
   * Get the packet aggregation capability supported by the interface. Standard
   * values are 0 (no support), 6 (6 packets) or 10 (10 packets).
   * <p>
   * This parameter is based on ''mocaIfPacketsAggrCapability'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Set the packet aggregation capability supported by the interface. Standard
   * values are 0 (no support), 6 (6 packets) or 10 (10 packets).
   * <p>
   * This parameter is based on ''mocaIfPacketsAggrCapability'' from
   * {{bibref|MOCA11-MIB}}.
  ...
  /**
   * Get the QoS object provides information on MoCA parameterized QoS for this
   * interface {{bibref|MoCAv1.1}}.
   *
   * @return the value
   */
  ...
  /**
   * Set the QoS object provides information on MoCA parameterized QoS for this
   * interface {{bibref|MoCAv1.1}}.
   *
  ...
  /**
   * Get the this table contains information about other MoCA devices currently
   * associated with this MoCA interface.
   *
   * @return the value
   */
  ...
  /**
   * Set the this table contains information about other MoCA devices currently
   * associated with this MoCA interface.
   *
