...
import org.broadbandforum.common.Alias;
	 ...
	 * @since TR181 v2.0
	 */
@CWMPObject(name = "Device.DHCPv4.Client.{i}.SentOption.{i}.", uniqueConstraints = {@CWMPUnique(names = {"Alias"}, functional = false),
	@CWMPUnique(names = {"Tag"})})
@XmlRootElement(name = "Device.DHCPv4.Client.SentOption")
@XmlType(name = "Device.DHCPv4.Client.SentOption")
...
public class SentOption {
	...
	/**
	 * Get the enables or disables this SentOption table entry.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the enables or disables this SentOption table entry.
	 *
	 * @since 2.0
