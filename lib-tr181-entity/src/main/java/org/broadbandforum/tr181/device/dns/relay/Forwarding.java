 ...
 */
package org.broadbandforum.tr181.device.dns.relay;
...
public class Forwarding {
	 ...
	 * @return this instance
	 */
	public Forwarding withDnsServer(IPAddress dnsServer) {
		this.dnsServer = dnsServer;
		return this;
	}

	/**
	 * Get the {{reference}} Specifies the IP interface over which the DNS query is sent.
	...
	/**
	 * Set the {{reference}} Specifies the IP interface over which the DNS query is sent.
