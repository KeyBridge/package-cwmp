...
public class IncrementalResult {
	...
	/**
	 * Get the change in the value of {{param|#.TestBytesSent}} between {{param|StartTime}} and {{param|EndTime}}.
	 *
	 * @since 2.9
	 * @return the value
	 */
	...
	/**
	 * Set the change in the value of {{param|#.TestBytesSent}} between {{param|StartTime}} and {{param|EndTime}}.
	 *
	 * @since 2.9
	 ...
	 */
	public IncrementalResult withTestBytesSent(Long testBytesSent) {
		this.testBytesSent = testBytesSent;
		return this;
	}
