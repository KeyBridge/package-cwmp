...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since TR181 v2.0
	 */
@CWMPObject(name = "Device.WiFi.EndPoint.{i}.WPS.")
@XmlRootElement(name = "Device.WiFi.EndPoint.WPS")
@XmlType(name = "Device.WiFi.EndPoint.WPS")
...
public class WPS {
	...
	/**
	 * {{list}} Indicates the WPS configuration methods supported by the device.  
...
Enumerated value must be one of [USBFlashDrive, Ethernet, ExternalNFCToken, IntegratedNFCToken, NFCInterface, PushButton, PIN]
	...
	/**
	 * Get the enables or disables WPS functionality for this end point.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the enables or disables WPS functionality for this end point.
	 *
	 * @since 2.0
	...
	/**
	 * Get the {{list}} Indicates the WPS configuration methods supported by the device.  
...
Enumerated value must be one of [USBFlashDrive, Ethernet, ExternalNFCToken, IntegratedNFCToken, NFCInterface, PushButton, PIN]
	...
	/**
	 * Set the {{list}} Indicates the WPS configuration methods supported by the device.  
...
Enumerated value must be one of [USBFlashDrive, Ethernet, ExternalNFCToken, IntegratedNFCToken, NFCInterface, PushButton, PIN]
	...
	/**
	 * Get the {{list}} Indicates the WPS configuration methods enabled on the device.
	 *
	 * @since 2.0
	 * @return the value
	 */
	...
	/**
	 * Set the {{list}} Indicates the WPS configuration methods enabled on the device.
	 *
	 * @since 2.0
