...
import org.broadbandforum.tr181.device.wifi.endpoint.ac.Stats;
	 ...
	 * @since TR181 v2.8
	 */
@CWMPObject(name = "Device.WiFi.EndPoint.{i}.AC.{i}.", uniqueConstraints = {@CWMPUnique(names = {"AccessCategory"})})
@XmlRootElement(name = "Device.WiFi.EndPoint.AC")
@XmlType(name = "Device.WiFi.EndPoint.AC")
...
public class AC {
	...
	/**
	 * Get the time between recording samples of the current transmit queue seconds.
	 *
	 * @since 2.8
	 * @return the value
	 */
	...
	/**
	 * Set the time between recording samples of the current transmit queue seconds.
	 *
	 * @since 2.8
