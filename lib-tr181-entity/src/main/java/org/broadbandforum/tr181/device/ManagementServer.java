...
import org.broadbandforum.tr181.device.managementserver.AutonomousTransferCompletePolicy;
import org.broadbandforum.tr181.device.managementserver.DUStateChangeComplPolicy;
import org.broadbandforum.tr181.device.managementserver.DownloadAvailability;
import org.broadbandforum.tr181.device.managementserver.EmbeddedDevice;
import org.broadbandforum.tr181.device.managementserver.InformParameter;
import org.broadbandforum.tr181.device.managementserver.ManageableDevice;
import org.broadbandforum.tr181.device.managementserver.StandbyPolicy;
import org.broadbandforum.tr181.device.managementserver.VirtualDevice;
...
public class ManagementServer {
	 ...
	 * @since 2.10
	 */
	@XmlElement(name = "ScheduleReboot")
	@CWMPParameter(access = "readWrite")
	public LocalDateTime scheduleReboot;
	/**
	 ...
	 * @since 2.10
	 */
	@XmlElement(name = "DelayReboot")
	@CWMPParameter(access = "readWrite", units = "seconds")
	@Size(min = -1)
	public Integer delayReboot;
	/**
...
Enumerated value must be one of [UDP]
	...
	/**
	 * Get an absolute date and time in UTC at which time the CPE will perform a reboot.
	 ...
	 * @return the value
	 */
	public LocalDateTime getScheduleReboot() {
		return scheduleReboot;
	}

	/**
	 * Set an absolute date and time in UTC at which time the CPE will perform a reboot.
	 ...
	 *
	 * @since 2.10
	 * @param scheduleReboot the input value
	 */
	public void  setScheduleReboot(LocalDateTime scheduleReboot) {
	 ...
	 * @return this instance
	 */
	public ManagementServer withScheduleReboot(LocalDateTime scheduleReboot) {
		this.scheduleReboot = scheduleReboot;
		return this;
	}

	/**
	 * Get the number of seconds from the time the CWMP session in which this parameter value is set is ended until the CPE performs a reboot.
	 ...
	 * @return the value
	 */
	public Integer getDelayReboot() {
		return delayReboot;
	}

	/**
	 * Set the number of seconds from the time the CWMP session in which this parameter value is set is ended until the CPE performs a reboot.

          Whenever the CPE reboots, this value MUST be reset by the CPE to -1.
	 *
	 * @since 2.10
	 * @param delayReboot the input value
	 */
	public void  setDelayReboot(Integer delayReboot) {
		this.delayReboot = delayReboot;
	}
	 ...
	 * @return this instance
	 */
	public ManagementServer withDelayReboot(Integer delayReboot) {
		this.delayReboot = delayReboot;
		return this;
	}
	...
	/**
	 * Get the if is not {{empty}}, the value of the STUN USERNAME attribute to be used in Binding Requests (only if message  integrity has been requested by the STUN server).
	...
	/**
	 * Set the if is not {{empty}}, the value of the STUN USERNAME attribute to be used in Binding Requests (only if message  integrity has been requested by the STUN server).
...
Enumerated value must be one of [UDP]
	 ...
	 * @return this instance
	 */
	public ManagementServer withDownloadAvailability(DownloadAvailability downloadAvailability) {
		this.downloadAvailability = downloadAvailability;
		return this;
	}
	...
	/**
	 * Get the each entry in this table represents a distinct Proxied Device that utilizes the Virtual CWMP Device Mechanism {{bibref|TR-069a4|Annex I.1.1}} for proxying devices.
	 *
	 * @return the value
	 */
	...
	/**
	 * Set the each entry in this table represents a distinct Proxied Device that utilizes the Virtual CWMP Device Mechanism {{bibref|TR-069a4|Annex I.1.1}} for proxying devices.
	 *
