...
import org.broadbandforum.common.IPAddress;
	 ...
	 * @since TR181 v2.0
	 */
@CWMPObject(name = "Device.IP.Diagnostics.UDPEchoConfig.")
@XmlRootElement(name = "Device.IP.Diagnostics.UDPEchoConfig")
@XmlType(name = "Device.IP.Diagnostics.UDPEchoConfig")
