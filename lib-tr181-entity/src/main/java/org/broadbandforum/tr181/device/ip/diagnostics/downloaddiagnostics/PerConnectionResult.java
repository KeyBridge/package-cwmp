...
@XmlType(name = "Device.IP.Diagnostics.DownloadDiagnostics.PerConnectionResult")
...
public class PerConnectionResult {
	...
	/**
	 * The number of bytes of the test file received during the FTP/HTTP transaction including FTP/HTTP headers, between {{param|BOMTime}} and {{param|EOMTime}}.
	 *
	 * @since 2.9
	 */
	...
	/**
	 * Get the number of bytes of the test file received during the FTP/HTTP transaction including FTP/HTTP headers, between {{param|BOMTime}} and {{param|EOMTime}}.
	 *
	 * @since 2.9
	 * @return the value
	 */
	...
	/**
	 * Set the number of bytes of the test file received during the FTP/HTTP transaction including FTP/HTTP headers, between {{param|BOMTime}} and {{param|EOMTime}}.
	 *
	 * @since 2.9
	 ...
	 * @return this instance
	 */
	public PerConnectionResult withTestBytesReceived(Long testBytesReceived) {
		this.testBytesReceived = testBytesReceived;
		return this;
	}
