...
import org.broadbandforum.tr181.device.routeradvertisement.InterfaceSetting;
...
public class RouterAdvertisement {
	...
	/**
	 * Get the enables or disables Router Advertisement.
	 *
	 * @since 2.2
	 * @return the value
	 */
	...
	/**
	 * Set the enables or disables Router Advertisement.
	 *
	 * @since 2.2
	 ...
	 */
	public RouterAdvertisement withEnable(Boolean enable) {
		this.enable = enable;
		return this;
	}

	/**
	 * Get the per-interface Router Advertisement (RA) configuration {{bibref|RFC4861}}. Table entries are created for use in sending Router Advertisements. 
	...
	/**
	 * Set the per-interface Router Advertisement (RA) configuration {{bibref|RFC4861}}. Table entries are created for use in sending Router Advertisements. 
	 ...
	 * @return this instance
	 */
	public RouterAdvertisement withInterfaceSetting(InterfaceSetting interfaceSetting) {
