 ...
 * <p>
 * If the device can establish more than one connection simultaneously (e.g. a
 * dual radio device), a separate {{object}} instance MUST be used for each
 * physical radio of the device. See {{bibref|TR-181i2|Appendix III.1}} for
 * additional information.
 * <p>
 * Note: A dual-band single-radio device (e.g. an 802.11a/b/g radio) can be
 * configured to operate at 2.4 or 5 GHz frequency bands, but only a single
 * frequency band is used to transmit/receive at a given time. Therefore, a
 * single {{object}} instance is used even for a dual-band radio.
 *
 * @since TR181 v2.0
 */
@CWMPObject(name = "Device.WiFi.Radio.{i}.", uniqueConstraints = {
...
public class Radio {
  ...
  /**
   * The current operational state of the radio (see {{bibref|TR-181i2|Section
   * 4.2.2}}). {{enum}}
   * <p>
   * When {{param|Enable}} is {{false}} then {{param}} SHOULD normally be
   * {{enum|Down}} (or {{enum|NotPresent}} or {{enum|Error}} if there is a fault
   * condition on the interface).
   * <p>
   * When {{param|Enable}} is changed to {{true}} then {{param}} SHOULD change
   * to {{enum|Up}} if and only if the interface is able to transmit and receive
   * network traffic; it SHOULD change to {{enum|Dormant}} if and only if the
   * interface is operable but is waiting for external actions before it can
   * transmit and receive network traffic (and subsequently change to
   * {{enum|Up}} if still operable when the expected actions have completed); it
   * SHOULD change to {{enum|LowerLayerDown}} if and only if the interface is
   * prevented from entering the {{enum|Up}} state because one or more of the
   * interfaces beneath it is down; it SHOULD remain in the {{enum|Error}} state
   * if there is an error or other fault condition detected on the interface; it
   * SHOULD remain in the {{enum|NotPresent}} state if the interface has missing
   * (typically hardware) components; it SHOULD change to {{enum|Unknown}} if
  ...
  /**
   * {{list}} {{reference|an interface object that is stacked immediately below
  ...
  /**
   * Indicates whether the interface points towards the Internet ({{true}}) or
   * towards End Devices ({{false}}).
   * <p>
   * For example:
   * <p>
   * For an Internet Gateway Device, {{param}} will be {{true}} for all WAN
   * interfaces and {{false}} for all LAN interfaces.
   * <p>
   * For a standalone WiFi Access Point that is connected via Ethernet to an
   * Internet Gateway Device, {{param}} will be {{true}} for the Ethernet
   * interface and {{false}} for the WiFi Radio interface.
   * <p>
  ...
  /**
   * {{list}} List items indicate the frequency bands at which the radio can
   * operate.
   *
   * @since 2.0
   */
   ...
   * <p>
   * If the radio supports multiple bands, and {{param}} is changed, then all
   * parameters whose value is not valid for the new frequency band (e.g.
   * {{param|Channel}}) MUST be set to a valid value (according to some CPE
  ...
  /**
   * {{list}} List items indicate which IEEE 802.11 standards this {{object}}
   * instance can support simultaneously, in the frequency band specified by
   * {{param|OperatingFrequencyBand}}.
   * <p>
   ...
   * {{enum|2.4GHz|OperatingFrequencyBand}}, only values {{enum|b}}, {{enum|g}},
   * {{enum|n}} are allowed.
   * <p>
   * If {{param|OperatingFrequencyBand}} is set to
   * {{enum|5GHz|OperatingFrequencyBand}}, only values {{enum|a}}, {{enum|n}},
   * {{enum|ac}} are allowed.
   *
   * @since 2.0
   */
  ...
  /**
   * {{list}} List items indicate which IEEE 802.11 standard this {{object}}
   ...
   * that the 802.11g standard {{bibref|802.11g-2003}} is used with a
   * backwards-compatible mode for 802.11b {{bibref|802.11b-1999}}. A value of
   * "g" means that only the 802.11g standard can be used.
   *
   * @since 2.0
   */
  ...
  /**
   * {{list}} List items represent possible radio channels for the wireless
  ...
  /**
   * {{list}} List items represent channels that the radio determines to be
  ...
  /**
   * The current radio channel used by the connection. To request automatic
   * channel selection, set {{param|AutoChannelEnable}} to {{true}}.
   * <p>
   * Whenever {{param|AutoChannelEnable}} is {{true}}, the value of the
   * {{param}} parameter MUST be the channel selected by the automatic channel
   * selection procedure.
   * <p>
   * Note: Valid {{param}} values depend on the {{param|OperatingFrequencyBand}}
   * and {{param|RegulatoryDomain}} values specified.
   *
   * @since 2.0
   */
  ...
  public Long channel;
  /**
   * Indicates whether automatic channel selection is supported by this radio.
   * If {{false}}, then {{param|AutoChannelEnable}} MUST be {{false}}.
   *
   * @since 2.0
   */
   ...
   * <p>
   * Set to {{false}} to disable the automatic channel selection procedure, in
   * which case the currently selected channel remains selected.
   * <p>
   * Set to {{true}} to enable the automatic channel selection procedure. This
   * procedure MUST automatically select the channel, and MAY also change it
   * subsequently.
   * <p>
   * {{param}} MUST automatically change to {{false}} whenever the channel is
   * manually selected, i.e. whenever the {{param|Channel}} parameter is
   * written.
   * <p>
   ...
   * only at boot time.
   * <p>
   * This parameter is significant only if {{param|AutoChannelEnable}} is set to
   * {{true}}.
   *
   * @since 2.0
   */
  ...
  /**
   * The channel bandwidth (applicable to 802.11n and 802.11ac specifications
   * only).
   *
   * @since 2.0
   */
   ...
   * channel mode (i.e. when {{param|OperatingChannelBandwidth}} is set to
  ...
  /**
   * The guard interval value between OFDM symbols (applicable to 802.11n and
  ...
  /**
   * The Modulation Coding Scheme index (applicable to 802.11n and 802.11ac
   * specifications only). Values from 0 to 15 MUST be supported
   * ({{bibref|802.11n-2009}}). Values from 0 to 9 MUST be supported for
   * {{bibref|802.11ac-2013}}. A value of -1 indicates automatic selection of
   * the MCS index.
   *
   * @since 2.0
   */
  ...
  public Integer mcs;
  /**
   * {{list}} List items represent supported transmit power levels as percentage
   * of full power. For example, "0,25,50,75,100".
   * <p>
   * A -1 item indicates auto mode (automatic decision by CPE). Auto mode allows
   * the ''Radio'' to adjust transmit power accordingly. For example, this can
   * be useful for power-save modes such as EU-CoC, where the ''Radio'' can
   * adjust power according to activity in the CPE.
   *
   * @since 2.0
   */
   ...
   * The value MUST be one of the values reported by the
   * {{param|TransmitPowerSupported}} parameter. A value of -1 indicates auto
   * mode (automatic decision by CPE).
   *
   * @since 2.0
   */
  ...
  /**
   * Indicates whether IEEE 802.11h {{bibref|802.11h-2003}} functionality is
   * supported by this radio. The value can be {{true}} only if the 802.11a or
   * the 802.11n@5GHz standard is supported (i.e.
   * {{param|SupportedFrequencyBands}} includes
   * {{enum|5GHz|SupportedFrequencyBands}} and {{param|SupportedStandards}}
   * includes {{enum|a|SupportedStandards}} and/or
   ...
   * value can be {{true}} only if the 802.11a or the 802.11n@5GHz standard is
   * supported and enabled (i.e. {{param|OperatingFrequencyBand}} is
  ...
  /**
   * The 802.11d Regulatory Domain. First two octets are {{bibref|ISO3166-1}}
  ...
  /**
   * The maximum number of retransmissions of a short packet i.e. a packet that
   * is no longer than the {{param|RTSThreshold}}. This corresponds to IEEE
   * 802.11 parameter ''dot11ShortRetryLimit'' {{bibref|802.11-2012}}.
   *
   * @since 2.8
   */
   ...
   * {{param|CCARequest}}. How this is achieved is a local matter to the CPE.
   * <p>
   * If this parameter is read before a CCARequest has been issued, then its
   * value is {{empty}}.
   *
   * @since 2.8
   */
  ...
  /**
   * A request for a received power indicator (RPI) histogram in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.23.4}}.
   *
   * @since 2.8
   */
  ...
  /**
   * Received power indicator (RPI) histogram report in the format specified in
   * {{bibref|802.11-2012|Clause 8.4.2.24.4}}.
   *
   * @since 2.8
   */
  ...
  /**
   * This specifies the current maximum size, in octets, of the MPDU that can be
   * delivered to the PHY. This parameter is based on
  ...
  /**
   * This indicates the number of octets in an MPDU, below which an RTS/CTS
   * handshake is not performed. This parameter is based on
  ...
  /**
   * This indicates the maximum number of transmission attempts of a frame, the
   * length of which is greater than {{param|RTSThreshold}}, that will be made
   * before a failure condition is indicated. This parameter is based on
   * ''dot11LongRetryLimit'' from {{bibref|802.11-2012}}.
   *
   * @since 2.8
   */
   ...
   * transmission of Beacon frames containing a TIM element whose DTIM Count
  ...
  /**
   * This determines whether or not packet aggregation (commonly called "frame
   * aggregation") is enabled. This applies only to 802.11n.
   *
   * @since 2.8
   */
  ...
  /**
   * {{list}} The set of data rates, in ''Mbps'', that have to be supported by
   * all stations that desire to join this BSS. The stations have to be able to
   * receive and transmit at each of the data rates listed in {{param}}. For
   * example, a value of "1,2", indicates that stations support 1 Mbps and 2
   * Mbps. Most control packets use a data rate in {{param}}.
   *
   * @since 2.8
   */
  ...
  /**
   * {{list}} Maximum access point data transmit rates in ''Mbps'' for unicast
   * frames (a superset of {{param|BasicDataTransmitRates}}). Given the value of
   * {{param|BasicDataTransmitRates}} from the example above, {{param}} might be
  ...
  /**
   * {{list}} Data transmit rates in ''Mbps'' for unicast frames at which the
   * access point will permit a station to connect (a subset of
   * {{param|OperationalDataTransmitRates}}). Given the values of
   * {{param|BasicDataTransmitRates}} and {{param|OperationalDataTransmitRates}}
   * from the examples above, {{param}} might be "1,2,5.5", indicating that the
   * AP will only permit connections at 1 Mbps, 2 Mbps and 5.5 Mbps, even though
   * it could theoretically accept connections at 11 Mbps.
   *
   * @since 2.8
   */
  ...
  /**
   * Throughput statistics for this interface. Packet counters here count 802.11
   * WiFi frames. See {{bibref|TR-181i2a5|Appendix III}} for further details.
   ...
   * interface becomes operationally down due to a previous administrative down
   * (i.e. the interface's {{param|#.Status}} parameter transitions to a down
   ...
   * interface status is discussed in {{bibref|TR-181i2a5|Section 4.2.2}}.
   */
  ...
  /**
   * Get the current operational state of the radio (see
  ...
  /**
   * Set the current operational state of the radio (see
   * {{bibref|TR-181i2|Section 4.2.2}}). {{enum}}
   * <p>
   * When {{param|Enable}} is {{false}} then {{param}} SHOULD normally be
   * {{enum|Down}} (or {{enum|NotPresent}} or {{enum|Error}} if there is a fault
  ...
  /**
   * Get the accumulated time in seconds since the radio entered its current
   * operational state.
   *
   * @since 2.0
   * @return the value
  ...
  /**
   * Set the accumulated time in seconds since the radio entered its current
   * operational state.
   *
   * @since 2.0
  ...
  /**
   * Get the {{list}} {{reference|an interface object that is stacked
   * immediately below this interface object}} See {{bibref|TR-181i2|Section
   * 4.2.1}}.
   * <p>
   * Note: Since {{object}} is a layer 1 interface, it is expected that
   * {{param}} will not be used.
  ...
  /**
   * Set the {{list}} {{reference|an interface object that is stacked
   * immediately below this interface object}} See {{bibref|TR-181i2|Section
   * 4.2.1}}.
   * <p>
   * Note: Since {{object}} is a layer 1 interface, it is expected that
  ...
  /**
   * Get the indicates whether the interface points towards the Internet
  ...
  /**
   * Set the indicates whether the interface points towards the Internet
   * ({{true}}) or towards End Devices ({{false}}).
   * <p>
   * For example:
   * <p>
  ...
  /**
   * Get the maximum PHY bit rate supported by this interface (expressed in
   * Mbps).
   *
   * @since 2.0
   * @return the value
  ...
  /**
   * Set the maximum PHY bit rate supported by this interface (expressed in
   * Mbps).
   *
   * @since 2.0
  ...
  /**
   * Get the {{list}} List items indicate the frequency bands at which the radio
   * can operate.
   *
   * @since 2.0
   * @return the value
  ...
  public Collection<String> getSupportedFrequencyBands() {
    if (this.supportedFrequencyBands == null) {
      this.supportedFrequencyBands = new ArrayList<>();
    }
    return supportedFrequencyBands;
  }

  /**
   * Set the {{list}} List items indicate the frequency bands at which the radio
   * can operate.
   *
   * @since 2.0
  ...
  /**
   * Get the {{list}} List items indicate which IEEE 802.11 standards this
   * {{object}} instance can support simultaneously, in the frequency band
   * specified by {{param|OperatingFrequencyBand}}.
   * <p>
   * Enumerated value must be one of [a, b, g, n, ac]
   * <p>
   * Each value indicates support for the indicated standard.
  ...
  public Collection<String> getSupportedStandards() {
    if (this.supportedStandards == null) {
      this.supportedStandards = new ArrayList<>();
    }
    return supportedStandards;
  }

  /**
   * Set the {{list}} List items indicate which IEEE 802.11 standards this
   * {{object}} instance can support simultaneously, in the frequency band
   * specified by {{param|OperatingFrequencyBand}}.
   * <p>
   * Enumerated value must be one of [a, b, g, n, ac]
  ...
  /**
   * Get the {{list}} List items indicate which IEEE 802.11 standard this
  ...
  public Collection<String> getOperatingStandards() {
    if (this.operatingStandards == null) {
      this.operatingStandards = new ArrayList<>();
    }
    return operatingStandards;
  }

  /**
   * Set the {{list}} List items indicate which IEEE 802.11 standard this
   * {{object}} instance is configured for.
   * <p>
   * Each value indicates support for the indicated standard.
   * <p>
  ...
  /**
   * Get the {{list}} List items represent possible radio channels for the
   * wireless standard (a, b, g, n) and the regulatory domain.
   * <p>
   * Ranges in the form "n-m" are permitted.
   * <p>
   * For example, for 802.11b and North America, would be "1-11".
  ...
  public Collection<String> getPossibleChannels() {
    if (this.possibleChannels == null) {
      this.possibleChannels = new ArrayList<>();
    }
    return possibleChannels;
  }

  /**
   * Set the {{list}} List items represent possible radio channels for the
   * wireless standard (a, b, g, n) and the regulatory domain.
   * <p>
   * Ranges in the form "n-m" are permitted.
   * <p>
  ...
  /**
   * Get the {{list}} List items represent channels that the radio determines to
  ...
  /**
   * Set the {{list}} List items represent channels that the radio determines to
   * be currently in use (including any that it is using itself).
   * <p>
   * Ranges in the form "n-m" are permitted.
   *
  ...
  /**
   * Get the current radio channel used by the connection. To request automatic
   * channel selection, set {{param|AutoChannelEnable}} to {{true}}.
   * <p>
   * Whenever {{param|AutoChannelEnable}} is {{true}}, the value of the
   * {{param}} parameter MUST be the channel selected by the automatic channel
  ...
  /**
   * Set the current radio channel used by the connection. To request automatic
   * channel selection, set {{param|AutoChannelEnable}} to {{true}}.
   * <p>
   * Whenever {{param|AutoChannelEnable}} is {{true}}, the value of the
   * {{param}} parameter MUST be the channel selected by the automatic channel
  ...
  /**
   * Get the indicates whether automatic channel selection is supported by this
   * radio. If {{false}}, then {{param|AutoChannelEnable}} MUST be {{false}}.
   *
   * @since 2.0
   * @return the value
   */
  ...
  /**
   * Set the indicates whether automatic channel selection is supported by this
   * radio. If {{false}}, then {{param|AutoChannelEnable}} MUST be {{false}}.
   *
   * @since 2.0
  ...
  /**
   * Get the time period in seconds between two consecutive automatic channel
   * selections. A value of 0 means that the automatic channel selection is done
   * only at boot time.
   * <p>
   * This parameter is significant only if {{param|AutoChannelEnable}} is set to
  ...
  /**
   * Set the time period in seconds between two consecutive automatic channel
   * selections. A value of 0 means that the automatic channel selection is done
   * only at boot time.
   * <p>
   * This parameter is significant only if {{param|AutoChannelEnable}} is set to
  ...
  /**
   * Get the channel bandwidth (applicable to 802.11n and 802.11ac
   * specifications only).
   *
   * @since 2.0
   * @return the value
  ...
  /**
   * Set the channel bandwidth (applicable to 802.11n and 802.11ac
   * specifications only).
   *
   * @since 2.0
  ...
  /**
   * Get the secondary extension channel position, applicable when operating in
   * wide channel mode (i.e. when {{param|OperatingChannelBandwidth}} is set to
   * {{enum|40MHz|OperatingChannelBandwidth}} or
   * {{enum|Auto|OperatingChannelBandwidth}}).
   *
   * @since 2.0
  ...
  /**
   * Set the secondary extension channel position, applicable when operating in
   * wide channel mode (i.e. when {{param|OperatingChannelBandwidth}} is set to
   * {{enum|40MHz|OperatingChannelBandwidth}} or
   * {{enum|Auto|OperatingChannelBandwidth}}).
   *
  ...
  /**
   * Get the guard interval value between OFDM symbols (applicable to 802.11n
  ...
  /**
   * Set the guard interval value between OFDM symbols (applicable to 802.11n
   * and 802.11ac specifications only).
   *
   * @since 2.0
  ...
  /**
   * Get the Modulation Coding Scheme index (applicable to 802.11n and 802.11ac
   * specifications only). Values from 0 to 15 MUST be supported
   * ({{bibref|802.11n-2009}}). Values from 0 to 9 MUST be supported for
   * {{bibref|802.11ac-2013}}. A value of -1 indicates automatic selection of
   * the MCS index.
  ...
  /**
   * Set the Modulation Coding Scheme index (applicable to 802.11n and 802.11ac
   * specifications only). Values from 0 to 15 MUST be supported
   * ({{bibref|802.11n-2009}}). Values from 0 to 9 MUST be supported for
   * {{bibref|802.11ac-2013}}. A value of -1 indicates automatic selection of
   * the MCS index.
  ...
  /**
   * Get the {{list}} List items represent supported transmit power levels as
   * percentage of full power. For example, "0,25,50,75,100".
   * <p>
   * A -1 item indicates auto mode (automatic decision by CPE). Auto mode allows
   * the ''Radio'' to adjust transmit power accordingly. For example, this can
   * be useful for power-save modes such as EU-CoC, where the ''Radio'' can
  ...
  /**
   * Set the {{list}} List items represent supported transmit power levels as
   * percentage of full power. For example, "0,25,50,75,100".
   * <p>
   * A -1 item indicates auto mode (automatic decision by CPE). Auto mode allows
   * the ''Radio'' to adjust transmit power accordingly. For example, this can
  ...
  /**
   * Get the indicates the current transmit power level as a percentage of full
  ...
  /**
   * Set the indicates the current transmit power level as a percentage of full
   * power. The value MUST be one of the values reported by the
   * {{param|TransmitPowerSupported}} parameter. A value of -1 indicates auto
   * mode (automatic decision by CPE).
   *
  ...
  /**
   * Get the indicates whether IEEE 802.11h {{bibref|802.11h-2003}}
   * functionality is supported by this radio. The value can be {{true}} only if
   * the 802.11a or the 802.11n@5GHz standard is supported (i.e.
   * {{param|SupportedFrequencyBands}} includes
   * {{enum|5GHz|SupportedFrequencyBands}} and {{param|SupportedStandards}}
   * includes {{enum|a|SupportedStandards}} and/or
   * {{enum|n|SupportedStandards}}).
  ...
  /**
   * Set the indicates whether IEEE 802.11h {{bibref|802.11h-2003}}
   * functionality is supported by this radio. The value can be {{true}} only if
   * the 802.11a or the 802.11n@5GHz standard is supported (i.e.
   * {{param|SupportedFrequencyBands}} includes
   * {{enum|5GHz|SupportedFrequencyBands}} and {{param|SupportedStandards}}
  ...
  /**
   * Get the indicates whether IEEE 802.11h functionality is enabled on this
   * radio. The value can be {{true}} only if the 802.11a or the 802.11n@5GHz
   * standard is supported and enabled (i.e. {{param|OperatingFrequencyBand}} is
   * {{enum|5GHz|OperatingFrequencyBand}} and {{param|OperatingStandards}}
   * includes {{enum|a|OperatingStandards}} and/or
   * {{enum|n|OperatingStandards}}).
   *
  ...
  /**
   * Set the indicates whether IEEE 802.11h functionality is enabled on this
   * radio. The value can be {{true}} only if the 802.11a or the 802.11n@5GHz
   * standard is supported and enabled (i.e. {{param|OperatingFrequencyBand}} is
   * {{enum|5GHz|OperatingFrequencyBand}} and {{param|OperatingStandards}}
   * includes {{enum|a|OperatingStandards}} and/or
  ...
  /**
   * Get the 802.11d Regulatory Domain. First two octets are
   * {{bibref|ISO3166-1}} two-character country code. The third octet is either
   * " " (all environments), "O" (outside) or "I" (inside).
   *
   * @since 2.0
   * @return the value
   */
  ...
  /**
   * Set the 802.11d Regulatory Domain. First two octets are
   * {{bibref|ISO3166-1}} two-character country code. The third octet is either
   * " " (all environments), "O" (outside) or "I" (inside).
   *
   * @since 2.0
  ...
  /**
   * Get the maximum number of retransmissions of a short packet i.e. a packet
   * that is no longer than the {{param|RTSThreshold}}. This corresponds to IEEE
   * 802.11 parameter ''dot11ShortRetryLimit'' {{bibref|802.11-2012}}.
   *
   * @since 2.8
   * @return the value
  ...
  /**
   * Set the maximum number of retransmissions of a short packet i.e. a packet
   * that is no longer than the {{param|RTSThreshold}}. This corresponds to IEEE
   * 802.11 parameter ''dot11ShortRetryLimit'' {{bibref|802.11-2012}}.
   *
   * @since 2.8
  ...
  /**
   * Get a request for the clear channel assessment (CCA) report in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.23.3}}.
   *
   * @since 2.8
   * @return the value
  ...
  /**
   * Set a request for the clear channel assessment (CCA) report in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.23.3}}.
   *
   * @since 2.8
  ...
  /**
   * Get the clear channel assessment (CCA) report in the format specified in
   * {{bibref|802.11-2012|Clause 8.4.2.24.3}}.
   * <p>
   * When read, the value of this parameter MUST correspond to
   * {{param|CCARequest}}. How this is achieved is a local matter to the CPE.
  ...
  /**
   * Set the clear channel assessment (CCA) report in the format specified in
   * {{bibref|802.11-2012|Clause 8.4.2.24.3}}.
   * <p>
   * When read, the value of this parameter MUST correspond to
   * {{param|CCARequest}}. How this is achieved is a local matter to the CPE.
  ...
  /**
   * Get a request for a received power indicator (RPI) histogram in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.23.4}}.
   *
   * @since 2.8
   * @return the value
  ...
  /**
   * Set a request for a received power indicator (RPI) histogram in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.23.4}}.
   *
   * @since 2.8
  ...
  /**
   * Get the received power indicator (RPI) histogram report in the format
  ...
  /**
   * Set the received power indicator (RPI) histogram report in the format
   * specified in {{bibref|802.11-2012|Clause 8.4.2.24.4}}.
   *
   * @since 2.8
  ...
  /**
   * Get the this specifies the current maximum size, in octets, of the MPDU
  ...
  /**
   * Set the this specifies the current maximum size, in octets, of the MPDU
   * that can be delivered to the PHY. This parameter is based on
   * ''dot11FragmentationThreshold'' from {{bibref|802.11-2012}}.
   *
   * @since 2.8
  ...
  /**
   * Get the this indicates the number of octets in an MPDU, below which an
  ...
  /**
   * Set the this indicates the number of octets in an MPDU, below which an
   * RTS/CTS handshake is not performed. This parameter is based on
   * ''dot11RTSThreshold'' from {{bibref|802.11-2012}}.
   *
   * @since 2.8
  ...
  /**
   * Get the this indicates the maximum number of transmission attempts of a
   * frame, the length of which is greater than {{param|RTSThreshold}}, that
   * will be made before a failure condition is indicated. This parameter is
   * based on ''dot11LongRetryLimit'' from {{bibref|802.11-2012}}.
   *
   * @since 2.8
   * @return the value
   */
  ...
  /**
   * Set the this indicates the maximum number of transmission attempts of a
   * frame, the length of which is greater than {{param|RTSThreshold}}, that
   * will be made before a failure condition is indicated. This parameter is
   * based on ''dot11LongRetryLimit'' from {{bibref|802.11-2012}}.
   *
  ...
  /**
   * Get the time interval between transmitting beacons (expressed in
   * milliseconds). This parameter is based on ''dot11BeaconPeriod'' from
   * {{bibref|802.11-2012}}.
   *
   * @since 2.8
   * @return the value
  ...
  /**
   * Set the time interval between transmitting beacons (expressed in
   * milliseconds). This parameter is based on ''dot11BeaconPeriod'' from
   * {{bibref|802.11-2012}}.
   *
   * @since 2.8
  ...
  /**
   * Get the this specifies the number of beacon intervals that elapse between
   * transmission of Beacon frames containing a TIM element whose DTIM Count
   * field is 0. This parameter is based on ''dot11DTIMPeriod'' from
   * {{bibref|802.11-2012}}.
   *
  ...
  /**
   * Set the this specifies the number of beacon intervals that elapse between
   * transmission of Beacon frames containing a TIM element whose DTIM Count
   * field is 0. This parameter is based on ''dot11DTIMPeriod'' from
   * {{bibref|802.11-2012}}.
   *
  ...
  /**
   * Get the this determines whether or not packet aggregation (commonly called
  ...
  /**
   * Set the this determines whether or not packet aggregation (commonly called
   * "frame aggregation") is enabled. This applies only to 802.11n.
   *
   * @since 2.8
  ...
  /**
   * Get the type of preamble. Longer preambles (more overhead) are needed by
   * 802.11g to coexist with legacy systems 802.11 and 802.11b.
   *
   * @since 2.8
   * @return the value
  ...
  /**
   * Set the type of preamble. Longer preambles (more overhead) are needed by
   * 802.11g to coexist with legacy systems 802.11 and 802.11b.
   *
   * @since 2.8
  ...
  /**
   * Get the {{list}} The set of data rates, in ''Mbps'', that have to be
   ...
   * {{param}}. For example, a value of "1,2", indicates that stations support 1
   * Mbps and 2 Mbps. Most control packets use a data rate in {{param}}.
   *
   * @since 2.8
   * @return the value
   */
  public Collection<String> getBasicDataTransmitRates() {
    if (this.basicDataTransmitRates == null) {
      this.basicDataTransmitRates = new ArrayList<>();
    }
    return basicDataTransmitRates;
  }

  /**
   * Set the {{list}} The set of data rates, in ''Mbps'', that have to be
   * supported by all stations that desire to join this BSS. The stations have
   * to be able to receive and transmit at each of the data rates listed in
   * {{param}}. For example, a value of "1,2", indicates that stations support 1
   * Mbps and 2 Mbps. Most control packets use a data rate in {{param}}.
  ...
  /**
   * Get the {{list}} Maximum access point data transmit rates in ''Mbps'' for
   * unicast frames (a superset of {{param|BasicDataTransmitRates}}). Given the
   * value of {{param|BasicDataTransmitRates}} from the example above, {{param}}
   * might be "1,2,5.5,11", indicating that unicast frames can additionally be
   * transmitted at 5.5 Mbps and 11 Mbps.
   *
   * @since 2.8
   * @return the value
  ...
  public Collection<String> getOperationalDataTransmitRates() {
    if (this.operationalDataTransmitRates == null) {
      this.operationalDataTransmitRates = new ArrayList<>();
    }
    return operationalDataTransmitRates;
  }

  /**
   * Set the {{list}} Maximum access point data transmit rates in ''Mbps'' for
   * unicast frames (a superset of {{param|BasicDataTransmitRates}}). Given the
   * value of {{param|BasicDataTransmitRates}} from the example above, {{param}}
   * might be "1,2,5.5,11", indicating that unicast frames can additionally be
   * transmitted at 5.5 Mbps and 11 Mbps.
  ...
  /**
   * Get the {{list}} Data transmit rates in ''Mbps'' for unicast frames at
   * which the access point will permit a station to connect (a subset of
   * {{param|OperationalDataTransmitRates}}). Given the values of
   * {{param|BasicDataTransmitRates}} and {{param|OperationalDataTransmitRates}}
   * from the examples above, {{param}} might be "1,2,5.5", indicating that the
   * AP will only permit connections at 1 Mbps, 2 Mbps and 5.5 Mbps, even though
  ...
  public Collection<String> getSupportedDataTransmitRates() {
    if (this.supportedDataTransmitRates == null) {
      this.supportedDataTransmitRates = new ArrayList<>();
    }
    return supportedDataTransmitRates;
  }

  /**
   * Set the {{list}} Data transmit rates in ''Mbps'' for unicast frames at
   * which the access point will permit a station to connect (a subset of
   * {{param|OperationalDataTransmitRates}}). Given the values of
   * {{param|BasicDataTransmitRates}} and {{param|OperationalDataTransmitRates}}
   * from the examples above, {{param}} might be "1,2,5.5", indicating that the
  ...
  /**
   * Get the throughput statistics for this interface. Packet counters here
   * count 802.11 WiFi frames. See {{bibref|TR-181i2a5|Appendix III}} for
   * further details. The CPE MUST reset the interface's Stats parameters
   * (unless otherwise stated in individual object or parameter descriptions)
   * either when the interface becomes operationally down due to a previous
   * administrative down (i.e. the interface's {{param|#.Status}} parameter
   * transitions to a down state after the interface is disabled) or when the
   * interface becomes administratively up (i.e. the interface's
  ...
  /**
   * Set the throughput statistics for this interface. Packet counters here
   * count 802.11 WiFi frames. See {{bibref|TR-181i2a5|Appendix III}} for
   * further details. The CPE MUST reset the interface's Stats parameters
   * (unless otherwise stated in individual object or parameter descriptions)
   * either when the interface becomes operationally down due to a previous
