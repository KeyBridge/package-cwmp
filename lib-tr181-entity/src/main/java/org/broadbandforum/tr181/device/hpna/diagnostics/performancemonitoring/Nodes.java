...
import org.broadbandforum.tr181.device.hpna.diagnostics.performancemonitoring.nodes.Node;
	 ...
	 * @since 2.0
	 */
@CWMPObject(name = "Device.HPNA.Diagnostics.PerformanceMonitoring.Nodes.")
@XmlRootElement(name = "Device.HPNA.Diagnostics.PerformanceMonitoring.Nodes")
@XmlType(name = "Device.HPNA.Diagnostics.PerformanceMonitoring.Nodes")
...
public class Nodes {
	...
	/**
	 * Get the per-node HPNA performance monitoring results during the current sample interval. Each table entry contains the results collected between an HPNA node (as indicated by {{param|MACAddress}}) and the local HPNA interface (as indicated by {{param|##.Interface}}).
	...
	/**
	 * Set the per-node HPNA performance monitoring results during the current sample interval. Each table entry contains the results collected between an HPNA node (as indicated by {{param|MACAddress}}) and the local HPNA interface (as indicated by {{param|##.Interface}}).
