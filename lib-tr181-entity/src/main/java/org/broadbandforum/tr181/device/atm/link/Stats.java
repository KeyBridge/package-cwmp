...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since TR181 v2.0
	 */
@CWMPObject(name = "Device.ATM.Link.{i}.Stats.")
@XmlRootElement(name = "Device.ATM.Link.Stats")
@XmlType(name = "Device.ATM.Link.Stats")
...
public class Stats {
	 ...
	 * @since 2.0
	 */
	@XmlElement(name = "TransmittedBlocks")
	@CWMPParameter(activeNotify = "canDeny")
	public Long transmittedBlocks;
	/**
	 * The current count of successfully received cells.
	 *
	 * @since 2.0
	 */
	@XmlElement(name = "ReceivedBlocks")
	@CWMPParameter(activeNotify = "canDeny")
	public Long receivedBlocks;
	/**
	 ...
	 * @return the value
	 */
	public Long getTransmittedBlocks() {
		return transmittedBlocks;
	}
	 ...
	 *
	 * @since 2.0
	 * @param transmittedBlocks the input value
	 */
	public void  setTransmittedBlocks(Long transmittedBlocks) {
		this.transmittedBlocks = transmittedBlocks;
	}
	 ...
	 * @return this instance
	 */
	public Stats withTransmittedBlocks(Long transmittedBlocks) {
		this.transmittedBlocks = transmittedBlocks;
		return this;
	}
	 ...
	 *
	 * @since 2.0
	 * @param receivedBlocks the input value
	 */
	public void  setReceivedBlocks(Long receivedBlocks) {
	 ...
	 * @return this instance
	 */
	public Stats withReceivedBlocks(Long receivedBlocks) {
		this.receivedBlocks = receivedBlocks;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public Stats withCrcErrors(Long crcErrors) {
		this.crcErrors = crcErrors;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public Stats withHecErrors(Long hecErrors) {
		this.hecErrors = hecErrors;
		return this;
	}
