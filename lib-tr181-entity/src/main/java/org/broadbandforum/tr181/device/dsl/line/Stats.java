...
import org.broadbandforum.tr181.device.dsl.line.stats.CurrentDay;
import org.broadbandforum.tr181.device.dsl.line.stats.LastShowtime;
import org.broadbandforum.tr181.device.dsl.line.stats.QuarterHour;
import org.broadbandforum.tr181.device.dsl.line.stats.Showtime;
import org.broadbandforum.tr181.device.dsl.line.stats.Total;
	 ...
	 * @since 2.0
	 */
@CWMPObject(name = "Device.DSL.Line.{i}.Stats.")
@XmlRootElement(name = "Device.DSL.Line.Stats")
@XmlType(name = "Device.DSL.Line.Stats")
...
public class Stats {
	...
	/**
	 * Get the this object contains DSL line total statistics. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Set the this object contains DSL line total statistics. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Get the this object contains DSL line statistics accumulated since the most recent DSL Showtime. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Set the this object contains DSL line statistics accumulated since the most recent DSL Showtime. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Get the this object contains DSL line statistics accumulated since the second most recent DSL Showtime. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Set the this object contains DSL line statistics accumulated since the second most recent DSL Showtime. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Get the this object contains DSL line statistics accumulated during the current day. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Set the this object contains DSL line statistics accumulated during the current day. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Get the this object contains DSL line statistics accumulated during the current quarter hour. See {{bibref|G.997.1|Chapter 7.2.6}}.
	...
	/**
	 * Set the this object contains DSL line statistics accumulated during the current quarter hour. See {{bibref|G.997.1|Chapter 7.2.6}}.
