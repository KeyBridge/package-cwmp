...
import org.broadbandforum.annotation.CWMPParameter;
	 ...
	 * @since TR181 v2.0
	 */
@CWMPObject(name = "Device.HomePlug.Interface.{i}.Stats.")
@XmlRootElement(name = "Device.HomePlug.Interface.Stats")
@XmlType(name = "Device.HomePlug.Interface.Stats")
...
public class Stats {
	...
	/**
	 * Get the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Acknowledged.
	 *
	 * @since 2.0
	 * @return the value
	 */
	public Long getMpdUTxAck() {
		return mpdUTxAck;
	}

	/**
	 * Set the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Acknowledged.
	 *
	 * @since 2.0
	 * @param mpdUTxAck the input value
	 */
	public void  setMpdUTxAck(Long mpdUTxAck) {
		this.mpdUTxAck = mpdUTxAck;
	}
	 ...
	 * @return this instance
	 */
	public Stats withMpdUTxAck(Long mpdUTxAck) {
		this.mpdUTxAck = mpdUTxAck;
		return this;
	}

	/**
	 * Get the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Collided
	 *
	 * @since 2.0
	 * @return the value
	 */
	public Long getMpdUTxCol() {
		return mpdUTxCol;
	}

	/**
	 * Set the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Collided
	 *
	 * @since 2.0
	 * @param mpdUTxCol the input value
	 */
	public void  setMpdUTxCol(Long mpdUTxCol) {
		this.mpdUTxCol = mpdUTxCol;
	}
	 ...
	 * @return this instance
	 */
	public Stats withMpdUTxCol(Long mpdUTxCol) {
		this.mpdUTxCol = mpdUTxCol;
		return this;
	}

	/**
	 * Get the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Failed
	 *
	 * @since 2.0
	 * @return the value
	 */
	public Long getMpdUTxFailed() {
		return mpdUTxFailed;
	}

	/**
	 * Set the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Transmitted and Failed
	 *
	 * @since 2.0
	 * @param mpdUTxFailed the input value
	 */
	public void  setMpdUTxFailed(Long mpdUTxFailed) {
		this.mpdUTxFailed = mpdUTxFailed;
	}
	 ...
	 * @return this instance
	 */
	public Stats withMpdUTxFailed(Long mpdUTxFailed) {
		this.mpdUTxFailed = mpdUTxFailed;
		return this;
	}

	/**
	 * Get the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Received and Acknowledged
	 *
	 * @since 2.0
	 * @return the value
	 */
	public Long getMpdURxAck() {
		return mpdURxAck;
	}

	/**
	 * Set the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Received and Acknowledged
	 *
	 * @since 2.0
	 * @param mpdURxAck the input value
	 */
	public void  setMpdURxAck(Long mpdURxAck) {
		this.mpdURxAck = mpdURxAck;
	}
	 ...
	 * @return this instance
	 */
	public Stats withMpdURxAck(Long mpdURxAck) {
		this.mpdURxAck = mpdURxAck;
		return this;
	}

	/**
	 * Get the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Received and Failed
	 *
	 * @since 2.0
	 * @return the value
	 */
	public Long getMpdURxFailed() {
		return mpdURxFailed;
	}

	/**
	 * Set the homePlug-specific statistic. The Number of MAC Protocol Data Units (MPDUs) Received and Failed
	 *
	 * @since 2.0
	 * @param mpdURxFailed the input value
	 */
	public void  setMpdURxFailed(Long mpdURxFailed) {
		this.mpdURxFailed = mpdURxFailed;
	}
	 ...
	 * @return this instance
	 */
	public Stats withMpdURxFailed(Long mpdURxFailed) {
		this.mpdURxFailed = mpdURxFailed;
		return this;
	}
