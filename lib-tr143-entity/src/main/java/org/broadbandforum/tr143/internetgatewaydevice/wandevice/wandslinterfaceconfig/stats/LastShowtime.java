...
public class LastShowtime {
	...
	/**
	 * Get the number of successfully received blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully received blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662.
	 *
	 * @since 1.0
	...
	/**
	 * Get the number of successfully transmitted blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662.
	 *
	 * @since 1.0
	 * @return the value
	 */
	...
	/**
	 * Set the number of successfully transmitted blocks since the second most recent DSL Showtime, where a block is as defined in RFC 2662.
	 *
	 * @since 1.0
