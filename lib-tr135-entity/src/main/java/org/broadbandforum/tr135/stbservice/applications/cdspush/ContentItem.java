 ...
 */
package org.broadbandforum.tr135.stbservice.applications.cdspush;
...
import org.broadbandforum.common.Alias;
	 ...
	 * @since TR135 v1.1
	 */
@CWMPObject(name = "STBService.{i}.Applications.CDSPush.ContentItem.{i}.", uniqueConstraints = {@CWMPUnique(names = {"ContentReferenceId"}),
