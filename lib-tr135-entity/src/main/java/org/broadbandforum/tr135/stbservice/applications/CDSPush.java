...
import org.broadbandforum.tr135.stbservice.applications.cdspush.ContentItem;
...
public class CDSPush {
	...
	/**
	 * It references the object instance dedicated to the CDS Push service. Example: “Device.Services.StorageService.1.LogicalVolume.1.Folder.1”.
	 *
	 * @since 1.1
	 */
	...
	/**
	 * Get the it references the object instance dedicated to the CDS Push service. Example: “Device.Services.StorageService.1.LogicalVolume.1.Folder.1”.
	 *
	 * @since 1.1
	 * @return the value
	 */
	...
	/**
	 * Set the it references the object instance dedicated to the CDS Push service. Example: “Device.Services.StorageService.1.LogicalVolume.1.Folder.1”.
	 *
	 * @since 1.1
	 ...
	 */
	public CDSPush withReference(String reference) {
		this.reference = reference;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public CDSPush withContentItem(ContentItem contentItem) {
